...
public abstract class f {
    ...
    private static final Uri f29110a = Uri.withAppendedPath((Uri) AbstractC3007a.e(ContactsContract.AUTHORITY_URI), "display_photo");
    ...
    public static boolean k(Uri uri) {
        return uri.getPath() != null && l(uri) && "com.android.contacts".equals(uri.getAuthority()) && !uri.getPath().startsWith((String) AbstractC3007a.e(f29110a.getPath()));
    }
