...
public class c {
    ...
    private File a() {
        if (this.f1104a == null) {
            synchronized (this) {
                try {
                    if (this.f1104a == null) {
                        this.f1104a = new File(this.f1105b.j().getFilesDir(), "PersistedInstallation." + this.f1105b.n() + ".json");
                    }
                } finally {
                }
            }
    ...
    public d b(d dVar) {
        try {
            ...
            File fileCreateTempFile = File.createTempFile("PersistedInstallation", "tmp", this.f1105b.j().getFilesDir());
