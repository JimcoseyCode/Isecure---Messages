...
abstract class b {
    ...
    private static List c(List list) {
        ...
        while (it.hasNext()) {
            ...
            arrayList.add(InterfaceC0515w0.c.a(videoProfile.getCodec(), videoProfile.getMediaType(), videoProfile.getBitrate(), videoProfile.getFrameRate(), videoProfile.getWidth(), videoProfile.getHeight(), videoProfile.getProfile(), 8, 0, 0));
        }
        return arrayList;
    }
}
