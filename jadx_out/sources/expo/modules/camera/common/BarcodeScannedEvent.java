...
public final class BarcodeScannedEvent implements Record {
    ...
    public BarcodeScannedEvent(int i10, String data, String raw, String type, ArrayList<Bundle> cornerPoints, Bundle bounds, Bundle bundle) {
        AbstractC2855l.g(data, "data");
        AbstractC2855l.g(raw, "raw");
