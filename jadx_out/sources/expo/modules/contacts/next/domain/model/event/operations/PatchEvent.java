...
@Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u00012\u00020\u0002B1\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0010\b\u0002\u0010\u0005\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00070\u0006\u0012\u000e\b\u0002\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u0006¢\u0006\u0004\b\n\u0010\u000bR\u0016\u0010\u0003\u001a\u00020\u0004X\u0096\u0004¢\u0006\n\n\u0002\u0010\u000e\u001a\u0004\b\f\u0010\rR\u0014\u0010\u000f\u001a\u00020\u0010X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0011\u0010\u0012¨\u0006\u0013"}, d2 = {"Lexpo/modules/contacts/next/domain/model/event/operations/PatchEvent;", "Lexpo/modules/contacts/next/domain/model/event/EventModel;", "Lexpo/modules/contacts/next/domain/model/Updatable$Data;", "dataId", "Lexpo/modules/contacts/next/domain/wrappers/DataId;", "startDate", "Lexpo/modules/kotlin/types/ValueOrUndefined;", "Lexpo/modules/contacts/next/domain/wrappers/ContactDate;", "label", "Lexpo/modules/contacts/next/domain/model/event/EventLabel;", "<init>", "(Ljava/lang/String;Lexpo/modules/kotlin/types/ValueOrUndefined;Lexpo/modules/kotlin/types/ValueOrUndefined;Lkotlin/jvm/internal/DefaultConstructorMarker;)V", "getDataId-sXKVoX8", "()Ljava/lang/String;", "Ljava/lang/String;", "contentValues", "Landroid/content/ContentValues;", "getContentValues", "()Landroid/content/ContentValues;", "expo-contacts_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class PatchEvent extends EventModel implements Updatable.Data {
    ...
    public /* synthetic */ PatchEvent(String str, ValueOrUndefined valueOrUndefined, ValueOrUndefined valueOrUndefined2, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i10 & 2) != 0) {
    ...
    private PatchEvent(String dataId, ValueOrUndefined<ContactDate> startDate, ValueOrUndefined<EventLabel> label) {
        ...
        AbstractC2855l.g(startDate, "startDate");
        AbstractC2855l.g(label, "label");
        ContactDate optional = startDate.getOptional();
        String strM128unboximpl = optional != null ? optional.m128unboximpl() : null;
        EventLabel optional2 = label.getOptional();
        super(strM128unboximpl, optional2 == null ? new EventLabel.Custom("other") : optional2, null);
        this.dataId = dataId;
        ContentValues contentValues = new ContentValues();
        if (!startDate.isUndefined()) {
            ContactDate optional3 = startDate.getOptional();
            String strM128unboximpl2 = optional3 != null ? optional3.m128unboximpl() : null;
            contentValues.put(Columns.DATA, strM128unboximpl2 == null ? null : strM128unboximpl2);
        }
