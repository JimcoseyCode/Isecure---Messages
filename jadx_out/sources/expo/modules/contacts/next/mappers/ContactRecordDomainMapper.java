...
public final class ContactRecordDomainMapper {
    ...
    /* JADX INFO: renamed from: toAppendable-MYK5hZQ, reason: not valid java name */
    public final Appendable m165toAppendableMYK5hZQ(NewRecord record, String rawContactId) {
        AbstractC2855l.g(record, "record");
        AbstractC2855l.g(rawContactId, "rawContactId");
        if (record instanceof EmailRecord.New) {
            return EmailMapper.INSTANCE.mo204toAppendableMYK5hZQ((EmailRecord.New) record, rawContactId);
        }
        if (record instanceof PhoneRecord.New) {
            return PhoneMapper.INSTANCE.mo204toAppendableMYK5hZQ((PhoneRecord.New) record, rawContactId);
        }
        if (record instanceof DateRecord.New) {
            return EventMapper.INSTANCE.mo204toAppendableMYK5hZQ((DateRecord.New) record, rawContactId);
        }
        if (record instanceof ExtraNameRecord.New) {
            return NicknameMapper.INSTANCE.mo204toAppendableMYK5hZQ((ExtraNameRecord.New) record, rawContactId);
        }
        if (record instanceof AddressRecord.New) {
            return StructuredPostalMapper.INSTANCE.mo204toAppendableMYK5hZQ((AddressRecord.New) record, rawContactId);
        }
        if (record instanceof RelationRecord.New) {
            return RelationMapper.INSTANCE.mo204toAppendableMYK5hZQ((RelationRecord.New) record, rawContactId);
        }
        if (record instanceof UrlAddressRecord.New) {
            return WebsiteMapper.INSTANCE.mo204toAppendableMYK5hZQ((UrlAddressRecord.New) record, rawContactId);
        }
        throw new IllegalArgumentException("Unsupported 'NewRecord' type: " + D.b(record.getClass()).o());
    }

    public final List<ContentValues> toContentValues(CreateContactRecord createContactRecord) {
        AbstractC2855l.g(createContactRecord, "createContactRecord");
        List listC = AbstractC2800q.c();
        listC.add(this.contactMapper.toNewStructuredName(createContactRecord).getContentValues());
        ...
        if (phones != null) {
            ArrayList arrayList2 = new ArrayList(AbstractC2800q.u(phones, 10));
    ...
    public final NewContact toDomain(CreateContactRecord record) {
        AbstractC2855l.g(record, "record");
        List listC = AbstractC2800q.c();
        listC.add(this.contactMapper.toNewStructuredName(record));
        listC.add(this.contactMapper.toNewOrganization(record));
        listC.add(this.contactMapper.toNewNote(record));
        listC.add(this.contactMapper.toNewPhoto(record));
        ...
        if (extraNames != null) {
            ...
            ArrayList arrayList4 = new ArrayList(AbstractC2800q.u(extraNames, 10));
            Iterator<T> it4 = extraNames.iterator();
            while (it4.hasNext()) {
        ...
        if (addresses != null) {
            ...
            ArrayList arrayList5 = new ArrayList(AbstractC2800q.u(addresses, 10));
        ...
        if (relations != null) {
            ...
            ArrayList arrayList6 = new ArrayList(AbstractC2800q.u(relations, 10));
            Iterator<T> it6 = relations.iterator();
            while (it6.hasNext()) {
        ...
        if (urlAddresses != null) {
            ...
            ArrayList arrayList7 = new ArrayList(AbstractC2800q.u(urlAddresses, 10));
            Iterator<T> it7 = urlAddresses.iterator();
            while (it7.hasNext()) {
                arrayList7.add(websiteMapper.toNew((UrlAddressRecord.New) it7.next()));
            }
            listC.addAll(arrayList7);
        }
        return new NewContact(Starred.m102constructorimpl(record.isFavourite() ? 1 : 0), AbstractC2800q.a(listC), null);
    }
    ...
    public final List<ExtractableField<? extends Extractable>> toExtractableFields(Collection<? extends ContactField> contactFields) {
        ...
        AbstractC2855l.g(contactFields, "contactFields");
    ...
    /* JADX INFO: renamed from: toPatchContact-k_3S2wM, reason: not valid java name */
    public final ContactPatch m166toPatchContactk_3S2wM(PatchContactRecord record, String rawContactId, String contactId, String structuredNameDataId, String organizationDataId, String noteDataId, String photoDataId) {
        AbstractC2855l.g(record, "record");
        AbstractC2855l.g(rawContactId, "rawContactId");
        ...
        if (IsChangingAnythingKt.isChangingStructuredName(record)) {
            if (structuredNameDataId != null) {
                contactPatchBuilder.withUpdatable(this.contactMapper.m162toPatchStructuredNameJtfS1E8(record, structuredNameDataId));
            } else {
                contactPatchBuilder.withAppendable(this.contactMapper.m158toAppendableStructuredNameMYK5hZQ(record, rawContactId));
            }
        }
        if (IsChangingAnythingKt.isChangingOrganization(record)) {
            if (organizationDataId != null) {
                contactPatchBuilder.withUpdatable(this.contactMapper.m160toPatchOrganizationJtfS1E8(record, organizationDataId));
            } else {
                contactPatchBuilder.withAppendable(this.contactMapper.m154toAppendableOrganizationMYK5hZQ(record, rawContactId));
            }
        }
        if (!record.getNote().isUndefined()) {
            if (noteDataId != null) {
                contactPatchBuilder.withUpdatable(this.contactMapper.m159toPatchNoteJtfS1E8(record, noteDataId));
            } else {
                contactPatchBuilder.withAppendable(this.contactMapper.m152toAppendableNoteMYK5hZQ(record, rawContactId));
            }
        }
        if (!record.getImage().isUndefined()) {
            if (photoDataId != null) {
                contactPatchBuilder.withUpdatable(this.contactMapper.m161toPatchPhotoJtfS1E8(record, photoDataId));
            } else {
                contactPatchBuilder.withAppendable(this.contactMapper.m156toAppendablePhotoMYK5hZQ(record, rawContactId));
            }
        }
        ...
        if (!emails.isUndefined() && emails.getOptional() != null) {
            ...
            for (Object obj : optional) {
                if (((Either) obj).isFirstType(D.b(EmailRecord.Patch.class))) {
                    arrayList.add(obj);
                } else {
                    arrayList2.add(obj);
                }
            ...
            while (it.hasNext()) {
                arrayList3.add((PatchRecord) ((Either) it.next()).getFirstType(D.b(EmailRecord.Patch.class)));
            }
            ArrayList arrayList4 = new ArrayList(AbstractC2800q.u(arrayList3, 10));
            Iterator it2 = arrayList3.iterator();
            while (it2.hasNext()) {
                arrayList4.add(contactPatchBuilder.getMapper().toPatchable((PatchRecord) it2.next()));
            }
            ...
            while (it4.hasNext()) {
                arrayList5.add((NewRecord) ((Either) it4.next()).getSecondType(D.b(EmailRecord.New.class)));
            }
            ArrayList arrayList6 = new ArrayList(AbstractC2800q.u(arrayList5, 10));
            Iterator it5 = arrayList5.iterator();
            while (it5.hasNext()) {
                arrayList6.add(contactPatchBuilder.getMapper().m165toAppendableMYK5hZQ((NewRecord) it5.next(), contactPatchBuilder.getRawContactId()));
            }
        ...
        if (!phones.isUndefined() && phones.getOptional() != null) {
            ...
            if (optional2 == null) {
                optional2 = AbstractC2800q.j();
            }
            ArrayList arrayList7 = new ArrayList();
            ArrayList arrayList8 = new ArrayList();
            for (Object obj2 : optional2) {
                if (((Either) obj2).isFirstType(D.b(PhoneRecord.Patch.class))) {
                    arrayList7.add(obj2);
                } else {
                    arrayList8.add(obj2);
                }
            ...
            ArrayList arrayList9 = new ArrayList(AbstractC2800q.u(list3, 10));
            Iterator it7 = list3.iterator();
            while (it7.hasNext()) {
                arrayList9.add((PatchRecord) ((Either) it7.next()).getFirstType(D.b(PhoneRecord.Patch.class)));
            }
            ArrayList arrayList10 = new ArrayList(AbstractC2800q.u(arrayList9, 10));
            Iterator it8 = arrayList9.iterator();
            while (it8.hasNext()) {
                arrayList10.add(contactPatchBuilder.getMapper().toPatchable((PatchRecord) it8.next()));
            }
            Iterator it9 = arrayList10.iterator();
            while (it9.hasNext()) {
                contactPatchBuilder.getToUpdate().add((Updatable) it9.next());
            }
            ArrayList arrayList11 = new ArrayList(AbstractC2800q.u(list4, 10));
            Iterator it10 = list4.iterator();
            while (it10.hasNext()) {
                arrayList11.add((NewRecord) ((Either) it10.next()).getSecondType(D.b(PhoneRecord.New.class)));
            }
            ArrayList arrayList12 = new ArrayList(AbstractC2800q.u(arrayList11, 10));
            Iterator it11 = arrayList11.iterator();
            while (it11.hasNext()) {
                arrayList12.add(contactPatchBuilder.getMapper().m165toAppendableMYK5hZQ((NewRecord) it11.next(), contactPatchBuilder.getRawContactId()));
            }
        ...
        if (!dates.isUndefined() && dates.getOptional() != null) {
            ...
            if (optional3 == null) {
                optional3 = AbstractC2800q.j();
            }
            ArrayList arrayList13 = new ArrayList();
            ArrayList arrayList14 = new ArrayList();
            for (Object obj3 : optional3) {
                if (((Either) obj3).isFirstType(D.b(DateRecord.Patch.class))) {
                    arrayList13.add(obj3);
                } else {
                    arrayList14.add(obj3);
                }
            }
            Pair pair3 = new Pair(arrayList13, arrayList14);
            List list5 = (List) pair3.getFirst();
            List list6 = (List) pair3.getSecond();
            ArrayList arrayList15 = new ArrayList(AbstractC2800q.u(list5, 10));
            Iterator it13 = list5.iterator();
            while (it13.hasNext()) {
                arrayList15.add((PatchRecord) ((Either) it13.next()).getFirstType(D.b(DateRecord.Patch.class)));
            }
            ArrayList arrayList16 = new ArrayList(AbstractC2800q.u(arrayList15, 10));
            Iterator it14 = arrayList15.iterator();
            while (it14.hasNext()) {
                arrayList16.add(contactPatchBuilder.getMapper().toPatchable((PatchRecord) it14.next()));
            }
            Iterator it15 = arrayList16.iterator();
            while (it15.hasNext()) {
                contactPatchBuilder.getToUpdate().add((Updatable) it15.next());
            }
            ArrayList arrayList17 = new ArrayList(AbstractC2800q.u(list6, 10));
            Iterator it16 = list6.iterator();
            while (it16.hasNext()) {
                arrayList17.add((NewRecord) ((Either) it16.next()).getSecondType(D.b(DateRecord.New.class)));
            }
            ArrayList arrayList18 = new ArrayList(AbstractC2800q.u(arrayList17, 10));
            Iterator it17 = arrayList17.iterator();
            while (it17.hasNext()) {
                arrayList18.add(contactPatchBuilder.getMapper().m165toAppendableMYK5hZQ((NewRecord) it17.next(), contactPatchBuilder.getRawContactId()));
            }
        ...
        if (!extraNames.isUndefined() && extraNames.getOptional() != null) {
            ...
            if (optional4 == null) {
                optional4 = AbstractC2800q.j();
            }
            ArrayList arrayList19 = new ArrayList();
            ArrayList arrayList20 = new ArrayList();
            for (Object obj4 : optional4) {
                if (((Either) obj4).isFirstType(D.b(ExtraNameRecord.Patch.class))) {
            ...
            List list7 = (List) pair4.getFirst();
            List list8 = (List) pair4.getSecond();
            ArrayList arrayList21 = new ArrayList(AbstractC2800q.u(list7, 10));
            Iterator it19 = list7.iterator();
            while (it19.hasNext()) {
                arrayList21.add((PatchRecord) ((Either) it19.next()).getFirstType(D.b(ExtraNameRecord.Patch.class)));
            }
            ArrayList arrayList22 = new ArrayList(AbstractC2800q.u(arrayList21, 10));
            Iterator it20 = arrayList21.iterator();
            while (it20.hasNext()) {
                arrayList22.add(contactPatchBuilder.getMapper().toPatchable((PatchRecord) it20.next()));
            }
            Iterator it21 = arrayList22.iterator();
            while (it21.hasNext()) {
                contactPatchBuilder.getToUpdate().add((Updatable) it21.next());
            }
            ArrayList arrayList23 = new ArrayList(AbstractC2800q.u(list8, 10));
            Iterator it22 = list8.iterator();
            while (it22.hasNext()) {
                arrayList23.add((NewRecord) ((Either) it22.next()).getSecondType(D.b(ExtraNameRecord.New.class)));
            }
            ArrayList arrayList24 = new ArrayList(AbstractC2800q.u(arrayList23, 10));
            Iterator it23 = arrayList23.iterator();
            while (it23.hasNext()) {
                arrayList24.add(contactPatchBuilder.getMapper().m165toAppendableMYK5hZQ((NewRecord) it23.next(), contactPatchBuilder.getRawContactId()));
            }
        ...
        if (!addresses.isUndefined() && addresses.getOptional() != null) {
            ...
            if (optional5 == null) {
                optional5 = AbstractC2800q.j();
            }
            ArrayList arrayList25 = new ArrayList();
            ArrayList arrayList26 = new ArrayList();
            for (Object obj5 : optional5) {
                if (((Either) obj5).isFirstType(D.b(AddressRecord.Patch.class))) {
                    arrayList25.add(obj5);
                } else {
                    arrayList26.add(obj5);
                }
            }
            Pair pair5 = new Pair(arrayList25, arrayList26);
            List list9 = (List) pair5.getFirst();
            List list10 = (List) pair5.getSecond();
            ArrayList arrayList27 = new ArrayList(AbstractC2800q.u(list9, 10));
            Iterator it25 = list9.iterator();
            while (it25.hasNext()) {
                arrayList27.add((PatchRecord) ((Either) it25.next()).getFirstType(D.b(AddressRecord.Patch.class)));
            }
            ArrayList arrayList28 = new ArrayList(AbstractC2800q.u(arrayList27, 10));
            Iterator it26 = arrayList27.iterator();
            while (it26.hasNext()) {
                arrayList28.add(contactPatchBuilder.getMapper().toPatchable((PatchRecord) it26.next()));
            }
            Iterator it27 = arrayList28.iterator();
            while (it27.hasNext()) {
                contactPatchBuilder.getToUpdate().add((Updatable) it27.next());
            }
            ArrayList arrayList29 = new ArrayList(AbstractC2800q.u(list10, 10));
            Iterator it28 = list10.iterator();
            while (it28.hasNext()) {
                arrayList29.add((NewRecord) ((Either) it28.next()).getSecondType(D.b(AddressRecord.New.class)));
            }
            ArrayList arrayList30 = new ArrayList(AbstractC2800q.u(arrayList29, 10));
            Iterator it29 = arrayList29.iterator();
            while (it29.hasNext()) {
                arrayList30.add(contactPatchBuilder.getMapper().m165toAppendableMYK5hZQ((NewRecord) it29.next(), contactPatchBuilder.getRawContactId()));
            }
        ...
        if (!relations.isUndefined() && relations.getOptional() != null) {
            ...
            if (optional6 == null) {
                optional6 = AbstractC2800q.j();
            }
            ArrayList arrayList31 = new ArrayList();
            ArrayList arrayList32 = new ArrayList();
            for (Object obj6 : optional6) {
                if (((Either) obj6).isFirstType(D.b(RelationRecord.Patch.class))) {
                    arrayList31.add(obj6);
                } else {
                    arrayList32.add(obj6);
                }
            }
            Pair pair6 = new Pair(arrayList31, arrayList32);
            List list11 = (List) pair6.getFirst();
            List list12 = (List) pair6.getSecond();
            ArrayList arrayList33 = new ArrayList(AbstractC2800q.u(list11, 10));
            Iterator it31 = list11.iterator();
            while (it31.hasNext()) {
                arrayList33.add((PatchRecord) ((Either) it31.next()).getFirstType(D.b(RelationRecord.Patch.class)));
            }
            ArrayList arrayList34 = new ArrayList(AbstractC2800q.u(arrayList33, 10));
            Iterator it32 = arrayList33.iterator();
            while (it32.hasNext()) {
                arrayList34.add(contactPatchBuilder.getMapper().toPatchable((PatchRecord) it32.next()));
            }
            Iterator it33 = arrayList34.iterator();
            while (it33.hasNext()) {
                contactPatchBuilder.getToUpdate().add((Updatable) it33.next());
            }
            ArrayList arrayList35 = new ArrayList(AbstractC2800q.u(list12, 10));
            Iterator it34 = list12.iterator();
            while (it34.hasNext()) {
                arrayList35.add((NewRecord) ((Either) it34.next()).getSecondType(D.b(RelationRecord.New.class)));
            }
            ArrayList arrayList36 = new ArrayList(AbstractC2800q.u(arrayList35, 10));
            Iterator it35 = arrayList35.iterator();
            while (it35.hasNext()) {
                arrayList36.add(contactPatchBuilder.getMapper().m165toAppendableMYK5hZQ((NewRecord) it35.next(), contactPatchBuilder.getRawContactId()));
            }
        ...
        if (!urlAddresses.isUndefined() && urlAddresses.getOptional() != null) {
            ...
            if (optional7 == null) {
                optional7 = AbstractC2800q.j();
            }
            ArrayList arrayList37 = new ArrayList();
            ArrayList arrayList38 = new ArrayList();
            for (Object obj7 : optional7) {
                if (((Either) obj7).isFirstType(D.b(UrlAddressRecord.Patch.class))) {
                    arrayList37.add(obj7);
                } else {
                    arrayList38.add(obj7);
                }
            }
            Pair pair7 = new Pair(arrayList37, arrayList38);
            List list13 = (List) pair7.getFirst();
            List list14 = (List) pair7.getSecond();
            ArrayList arrayList39 = new ArrayList(AbstractC2800q.u(list13, 10));
            Iterator it37 = list13.iterator();
            while (it37.hasNext()) {
                arrayList39.add((PatchRecord) ((Either) it37.next()).getFirstType(D.b(UrlAddressRecord.Patch.class)));
            }
            ArrayList arrayList40 = new ArrayList(AbstractC2800q.u(arrayList39, 10));
            Iterator it38 = arrayList39.iterator();
            while (it38.hasNext()) {
                arrayList40.add(contactPatchBuilder.getMapper().toPatchable((PatchRecord) it38.next()));
            }
            Iterator it39 = arrayList40.iterator();
            while (it39.hasNext()) {
                contactPatchBuilder.getToUpdate().add((Updatable) it39.next());
            }
            ArrayList arrayList41 = new ArrayList(AbstractC2800q.u(list14, 10));
            Iterator it40 = list14.iterator();
            while (it40.hasNext()) {
                arrayList41.add((NewRecord) ((Either) it40.next()).getSecondType(D.b(UrlAddressRecord.New.class)));
            }
            ArrayList arrayList42 = new ArrayList(AbstractC2800q.u(arrayList41, 10));
            Iterator it41 = arrayList41.iterator();
            while (it41.hasNext()) {
                arrayList42.add(contactPatchBuilder.getMapper().m165toAppendableMYK5hZQ((NewRecord) it41.next(), contactPatchBuilder.getRawContactId()));
            }
    ...
    public final Updatable toPatchable(PatchRecord record) {
        ...
        throw new IllegalArgumentException("Unsupported 'PatchRecord' type: " + D.b(record.getClass()).o());
    }
    ...
    public final Updatable toUpdatable(ExistingRecord record) {
        ...
        throw new IllegalArgumentException("Unsupported 'ExistingRecord' type: " + D.b(record.getClass()).o());
    }

    /* JADX INFO: renamed from: toUpdateContact-Z-oEY38, reason: not valid java name */
    public final UpdateContact m167toUpdateContactZoEY38(CreateContactRecord record, String contactId, String rawContactId) {
        AbstractC2855l.g(record, "record");
        AbstractC2855l.g(contactId, "contactId");
        AbstractC2855l.g(rawContactId, "rawContactId");
        List listC = AbstractC2800q.c();
        listC.add(this.contactMapper.m157toAppendableStructuredNameMYK5hZQ(record, rawContactId));
        listC.add(this.contactMapper.m153toAppendableOrganizationMYK5hZQ(record, rawContactId));
        listC.add(new AppendableNote(rawContactId, record.getNote(), null));
        listC.add(this.contactMapper.m155toAppendablePhotoMYK5hZQ(record, rawContactId));
        List<EmailRecord.New> emails = record.getEmails();
        if (emails != null) {
            ArrayList arrayList = new ArrayList(AbstractC2800q.u(emails, 10));
            Iterator<T> it = emails.iterator();
            while (it.hasNext()) {
                arrayList.add(EmailMapper.INSTANCE.mo204toAppendableMYK5hZQ((EmailRecord.New) it.next(), rawContactId));
            }
            listC.addAll(arrayList);
        }
        List<PhoneRecord.New> phones = record.getPhones();
        if (phones != null) {
            ...
            Iterator<T> it2 = phones.iterator();
            while (it2.hasNext()) {
                arrayList2.add(PhoneMapper.INSTANCE.mo204toAppendableMYK5hZQ((PhoneRecord.New) it2.next(), rawContactId));
            }
            listC.addAll(arrayList2);
        }
        List<DateRecord.New> dates = record.getDates();
        if (dates != null) {
            ...
            Iterator<T> it3 = dates.iterator();
            while (it3.hasNext()) {
                arrayList3.add(EventMapper.INSTANCE.mo204toAppendableMYK5hZQ((DateRecord.New) it3.next(), rawContactId));
            }
            listC.addAll(arrayList3);
        }
        List<ExtraNameRecord.New> extraNames = record.getExtraNames();
        if (extraNames != null) {
            ...
            Iterator<T> it4 = extraNames.iterator();
            while (it4.hasNext()) {
                arrayList4.add(NicknameMapper.INSTANCE.mo204toAppendableMYK5hZQ((ExtraNameRecord.New) it4.next(), rawContactId));
            }
            listC.addAll(arrayList4);
        }
        List<AddressRecord.New> addresses = record.getAddresses();
        if (addresses != null) {
            ...
            Iterator<T> it5 = addresses.iterator();
            while (it5.hasNext()) {
                arrayList5.add(StructuredPostalMapper.INSTANCE.mo204toAppendableMYK5hZQ((AddressRecord.New) it5.next(), rawContactId));
            }
            listC.addAll(arrayList5);
        }
        List<RelationRecord.New> relations = record.getRelations();
        if (relations != null) {
            ...
            Iterator<T> it6 = relations.iterator();
            while (it6.hasNext()) {
                arrayList6.add(RelationMapper.INSTANCE.mo204toAppendableMYK5hZQ((RelationRecord.New) it6.next(), rawContactId));
            }
            listC.addAll(arrayList6);
        }
        List<UrlAddressRecord.New> urlAddresses = record.getUrlAddresses();
        if (urlAddresses != null) {
            ...
            Iterator<T> it7 = urlAddresses.iterator();
            while (it7.hasNext()) {
                arrayList7.add(WebsiteMapper.INSTANCE.mo204toAppendableMYK5hZQ((UrlAddressRecord.New) it7.next(), rawContactId));
            }
            listC.addAll(arrayList7);
        }
        return new UpdateContact(rawContactId, new ExistingStarred(contactId, record.isFavourite(), null), AbstractC2800q.a(listC), null);
    }
    ...
    public final <TRecord extends ExistingRecord, TModel extends Extractable> TRecord toRecord(TModel model) {
        ...
        AbstractC2855l.e(dto, "null cannot be cast to non-null type TRecord of expo.modules.contacts.next.mappers.ContactRecordDomainMapper.toRecord");
        return dto;
    }
}
