...
public final class WebsiteMapper implements ListDataPropertyMapper<ExistingWebsite, UrlAddressRecord.Existing, UrlAddressRecord.New> {
    ...
    public final PatchWebsite toPatch(UrlAddressRecord.Patch record) {
        AbstractC2855l.g(record, "record");
        return new PatchWebsite(DataId.m137constructorimpl(record.getId()), record.getUrl(), WebsiteLabelMapper.INSTANCE.toDomain(record.getLabel()), null);
    }
    ...
    public AppendableWebsite mo204toAppendableMYK5hZQ(UrlAddressRecord.New newValue, String rawContactId) {
    ...
    public ExistingWebsite toUpdatable(UrlAddressRecord.Existing newValue) {
        AbstractC2855l.g(newValue, "newValue");
        return new ExistingWebsite(DataId.m137constructorimpl(newValue.getId()), newValue.getUrl(), WebsiteLabelMapper.INSTANCE.toDomain(newValue.getLabel()), null);
    }
}
