...
public final class PhoneMapper implements ListDataPropertyMapper<ExistingPhone, PhoneRecord.Existing, PhoneRecord.New> {
    ...
    public final PatchPhone toPatch(PhoneRecord.Patch record) {
        AbstractC2855l.g(record, "record");
        return new PatchPhone(DataId.m137constructorimpl(record.getId()), record.getNumber(), PhoneLabelMapper.INSTANCE.toDomain(record.getLabel()), null);
    }
    ...
    public AppendablePhone mo204toAppendableMYK5hZQ(PhoneRecord.New newValue, String rawContactId) {
    ...
    public ExistingPhone toUpdatable(PhoneRecord.Existing newValue) {
        AbstractC2855l.g(newValue, "newValue");
        return new ExistingPhone(DataId.m137constructorimpl(newValue.getId()), newValue.getNumber(), PhoneLabelMapper.INSTANCE.toDomain(newValue.getLabel()), null);
    }
}
