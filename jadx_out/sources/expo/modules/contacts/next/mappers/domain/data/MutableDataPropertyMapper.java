...
public interface MutableDataPropertyMapper<TDomain extends Extractable.Data, TDto> extends DataPropertyMapper<TDomain, TDto> {
    ...
    Appendable mo174toAppendableMYK5hZQ(TDto newValue, String rawContactId);

    /* JADX INFO: renamed from: toUpdatable-bM46d30, reason: not valid java name */
    Updatable.Data mo175toUpdatablebM46d30(String dataId, TDto newValue);
}
