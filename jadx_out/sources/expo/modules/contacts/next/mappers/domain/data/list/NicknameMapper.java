...
public final class NicknameMapper implements ListDataPropertyMapper<ExistingNickname, ExtraNameRecord.Existing, ExtraNameRecord.New> {
    ...
    public final PatchNickname toPatch(ExtraNameRecord.Patch record) {
        AbstractC2855l.g(record, "record");
        return new PatchNickname(DataId.m137constructorimpl(record.getId()), record.getName(), NicknameLabelMapper.INSTANCE.toDomain(record.getLabel()), null);
    }
    ...
    public AppendableNickname mo204toAppendableMYK5hZQ(ExtraNameRecord.New newValue, String rawContactId) {
    ...
    public ExistingNickname toUpdatable(ExtraNameRecord.Existing newValue) {
        AbstractC2855l.g(newValue, "newValue");
        return new ExistingNickname(DataId.m137constructorimpl(newValue.getId()), newValue.getName(), NicknameLabelMapper.INSTANCE.toDomain(newValue.getLabel()), null);
    }
}
