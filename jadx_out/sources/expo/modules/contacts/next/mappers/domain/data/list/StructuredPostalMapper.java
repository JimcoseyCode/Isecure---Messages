...
public final class StructuredPostalMapper implements ListDataPropertyMapper<ExistingStructuredPostal, AddressRecord.Existing, AddressRecord.New> {
    ...
    public final PatchStructuredPostal toPatch(AddressRecord.Patch record) {
        AbstractC2855l.g(record, "record");
        return new PatchStructuredPostal(DataId.m137constructorimpl(record.getId()), record.getStreet(), record.getCity(), record.getRegion(), record.getPostcode(), record.getCountry(), StructuredPostalLabelMapper.INSTANCE.toDomain(record.getLabel()), null);
    }
    ...
    public AppendableStructuredPostal mo204toAppendableMYK5hZQ(AddressRecord.New newValue, String rawContactId) {
    ...
    public ExistingStructuredPostal toUpdatable(AddressRecord.Existing newValue) {
        AbstractC2855l.g(newValue, "newValue");
        return new ExistingStructuredPostal(DataId.m137constructorimpl(newValue.getId()), newValue.getStreet(), newValue.getCity(), newValue.getRegion(), newValue.getPostcode(), newValue.getCountry(), StructuredPostalLabelMapper.INSTANCE.toDomain(newValue.getLabel()), null);
    }
}
