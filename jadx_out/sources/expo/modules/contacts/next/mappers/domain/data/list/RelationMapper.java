...
public final class RelationMapper implements ListDataPropertyMapper<ExistingRelation, RelationRecord.Existing, RelationRecord.New> {
    ...
    public final PatchRelation toPatch(RelationRecord.Patch record) {
        AbstractC2855l.g(record, "record");
        return new PatchRelation(DataId.m137constructorimpl(record.getId()), record.getName(), RelationshipLabelMapper.INSTANCE.toDomain(record.getLabel()), null);
    }
    ...
    public AppendableRelation mo204toAppendableMYK5hZQ(RelationRecord.New newValue, String rawContactId) {
    ...
    public ExistingRelation toUpdatable(RelationRecord.Existing newValue) {
        AbstractC2855l.g(newValue, "newValue");
        return new ExistingRelation(DataId.m137constructorimpl(newValue.getId()), newValue.getName(), RelationshipLabelMapper.INSTANCE.toDomain(newValue.getLabel()), null);
    }
}
