...
@f(c = "expo.modules.medialibrary.next.objects.asset.delegates.AssetLegacyDelegate", f = "AssetLegacyDelegate.kt", l = {145}, m = "getMimeType-dctPOJs")
@Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
final class AssetLegacyDelegate$getMimeType$1 extends kotlin.coroutines.jvm.internal.d {
    Object L$0;
    int label;
    ...
    AssetLegacyDelegate$getMimeType$1(AssetLegacyDelegate assetLegacyDelegate, n7.f fVar) {
        super(fVar);
