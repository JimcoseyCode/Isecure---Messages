...
public final class Uint32Array implements TypedArray, GenericTypedArray<w>, RawTypedArrayHolder {
    ...
    public /* bridge */ /* synthetic */ w get(int i10) {
        return w.h(m256getOGnWXxg(i10));
    }

    /* JADX INFO: renamed from: get-OGnWXxg, reason: not valid java name */
    public int m256getOGnWXxg(int index) {
        if (index < 0 || index >= getLength()) {
            throw new IndexOutOfBoundsException();
        }
        return w.j(read4Byte(index * 4));
    }
    ...
    @Override // expo.modules.kotlin.typedarray.GenericTypedArray
    public /* bridge */ /* synthetic */ void set(int i10, w wVar) {
        m257setQn1smSk(i10, wVar.q());
    }

    /* JADX INFO: renamed from: set-Qn1smSk, reason: not valid java name */
    public void m257setQn1smSk(int index, int value) {
        if (index < 0 || index >= getLength()) {
            throw new IndexOutOfBoundsException();
        }
