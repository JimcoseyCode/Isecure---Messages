...
public final class Uint8Array implements TypedArray, GenericTypedArray<v>, RawTypedArrayHolder {
    ...
    public /* bridge */ /* synthetic */ v get(int i10) {
        return v.h(m258getWa3L5BU(i10));
    }

    /* JADX INFO: renamed from: get-Wa3L5BU, reason: not valid java name */
    public byte m258getWa3L5BU(int index) {
    ...
    public /* bridge */ /* synthetic */ void set(int i10, v vVar) {
        m259setEK6454(i10, vVar.q());
    }

    /* JADX INFO: renamed from: set-EK-6454, reason: not valid java name */
    public void m259setEK6454(int index, byte value) {
        if (index < 0 || index >= getLength()) {
            throw new IndexOutOfBoundsException();
        }
