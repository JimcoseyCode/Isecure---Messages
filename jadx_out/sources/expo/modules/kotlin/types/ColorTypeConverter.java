...
@Metadata(d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0013\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\"\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u00072\b\u0010\b\u001a\u0004\u0018\u00010\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016J\"\u0010\f\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\r2\b\u0010\b\u001a\u0004\u0018\u00010\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016J\u0010\u0010\u000e\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u000fH\u0002J\u0010\u0010\u0010\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0011H\u0002J\u0010\u0010\u0012\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0013H\u0002J\b\u0010\u0014\u001a\u00020\u0015H\u0016J\b\u0010\u0016\u001a\u00020\u000bH\u0016¨\u0006\u0017"}, d2 = {"Lexpo/modules/kotlin/types/ColorTypeConverter;", "Lexpo/modules/kotlin/types/DynamicAwareTypeConverters;", "Landroid/graphics/Color;", "<init>", "()V", "convertFromDynamic", "value", "Lcom/facebook/react/bridge/Dynamic;", "context", "Lexpo/modules/kotlin/AppContext;", "forceConversion", PointerEventHelper.POINTER_TYPE_UNKNOWN, "convertFromAny", PointerEventHelper.POINTER_TYPE_UNKNOWN, "colorFromDoubleArray", PointerEventHelper.POINTER_TYPE_UNKNOWN, "colorFromInt", PointerEventHelper.POINTER_TYPE_UNKNOWN, "colorFromString", PointerEventHelper.POINTER_TYPE_UNKNOWN, "getCppRequiredTypes", "Lexpo/modules/kotlin/jni/ExpectedType;", "isTrivial", "expo-modules-core_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class ColorTypeConverter extends DynamicAwareTypeConverters<Color> {
    ...
    private final Color colorFromDoubleArray(double[] value) {
        Double dL = AbstractC2793j.L(value, 3);
        Color colorValueOf = Color.valueOf((float) value[0], (float) value[1], (float) value[2], (float) (dL != null ? dL.doubleValue() : 1.0d));
        AbstractC2855l.f(colorValueOf, "valueOf(...)");
        return colorValueOf;
    }
    ...
    private final Color colorFromString(String value) {
        ...
        AbstractC2855l.f(colorValueOf2, "valueOf(...)");
    ...
    public Color convertFromAny(Object value, AppContext context, boolean forceConversion) throws UnexpectedException {
        ...
        throw new UnexpectedException("Unknown argument type: " + D.b(value.getClass()));
    }
    ...
    public Color convertFromDynamic(Dynamic value, AppContext context, boolean forceConversion) throws DynamicCastException, UnexpectedException {
        ...
        return colorFromDoubleArray(AbstractC2800q.L0(arrayList2));
    }
}
