...
@f(c = "expo.modules.securestore.SecureStoreModule$definition$lambda$7$$inlined$Coroutine$7", f = "SecureStoreModule.kt", l = {271}, m = "invokeSuspend")
...
public final class SecureStoreModule$definition$lambda$7$$inlined$Coroutine$7 extends l implements o {
    /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ SecureStoreModule this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SecureStoreModule$definition$lambda$7$$inlined$Coroutine$7(n7.f fVar, SecureStoreModule secureStoreModule) {
        super(3, fVar);
    ...
    public final Object invoke(N n10, Object[] objArr, n7.f fVar) {
        SecureStoreModule$definition$lambda$7$$inlined$Coroutine$7 secureStoreModule$definition$lambda$7$$inlined$Coroutine$7 = new SecureStoreModule$definition$lambda$7$$inlined$Coroutine$7(fVar, this.this$0);
        secureStoreModule$definition$lambda$7$$inlined$Coroutine$7.L$0 = objArr;
        return secureStoreModule$definition$lambda$7$$inlined$Coroutine$7.invokeSuspend(C2735B.f28704a);
    }
