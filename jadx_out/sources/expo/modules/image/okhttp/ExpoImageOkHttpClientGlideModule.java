...
public final class ExpoImageOkHttpClientGlideModule extends K1.b {
    ...
    public void registerComponents(Context context, com.bumptech.glide.b glide, h registry) {
        ...
        z zVarC = new z.a().g(SharedCookieJar.INSTANCE).c();
        registry.u(B1.h.class, InputStream.class, new a.C0204a(zVarC));
        registry.o(GlideUrlWrapper.class, InputStream.class, new GlideUrlWrapperLoader.Factory(zVarC));
    }
}
