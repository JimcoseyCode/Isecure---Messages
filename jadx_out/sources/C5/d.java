...
public abstract class d {
    ...
    private static TimeInterpolator c(String str) {
        if (!e(str, "cubic-bezier")) {
            if (e(str, "path")) {
                return new PathInterpolator(g.e(b(str, "path")));
            }
    ...
    public static int f(Context context, int i10, int i11) {
        return AbstractC2424b.d(context, i10, i11);
    }
    ...
    public static n h(Context context, int i10, int i11) {
        TypedValue typedValueA = AbstractC2424b.a(context, i10);
        TypedArray typedArrayObtainStyledAttributes = typedValueA == null ? context.obtainStyledAttributes(null, k.f9448C3, 0, i11) : context.obtainStyledAttributes(typedValueA.resourceId, k.f9448C3);
        n nVar = new n();
        try {
            float f10 = typedArrayObtainStyledAttributes.getFloat(k.f9464E3, Float.MIN_VALUE);
            if (f10 == Float.MIN_VALUE) {
                throw new IllegalArgumentException("A MaterialSpring style must have stiffness value.");
            }
            float f11 = typedArrayObtainStyledAttributes.getFloat(k.f9456D3, Float.MIN_VALUE);
