...
public abstract class z {
    ...
    public static final RectF f3633a = new RectF(-1.0f, -1.0f, 1.0f, 1.0f);
    ...
    public static Matrix c(RectF rectF) {
        ...
        matrix.setRectToRect(f3633a, rectF, Matrix.ScaleToFit.FILL);
        return matrix;
    }
    ...
    public static Matrix e(RectF rectF, RectF rectF2, int i10, boolean z10) {
        Matrix matrix = new Matrix();
        matrix.setRectToRect(rectF, f3633a, Matrix.ScaleToFit.FILL);
    ...
    public static Size p(Size size, int i10) {
        H0.g.b(i10 % 90 == 0, "Invalid rotation degrees: " + i10);
