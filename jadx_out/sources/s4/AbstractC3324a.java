...
public abstract class AbstractC3324a {
    ...
    /* JADX INFO: compiled from: r8-map-id-061e463ed15b965618257332b2076f08a8430850913ea9e10e0349edf4e95e68 */
    public static class C0356a extends RuntimeException {
        public C0356a(String str, Parcel parcel) {
    ...
    public static int F(Parcel parcel) {
        ...
        if (iU != 20293) {
            throw new C0356a("Expected object header. Got 0x".concat(String.valueOf(Integer.toHexString(iY))), parcel);
        }
        int i10 = iD + iDataPosition;
        if (i10 >= iDataPosition && i10 <= parcel.dataSize()) {
            return i10;
        }
        throw new C0356a("Size read is invalid start=" + iDataPosition + " end=" + i10, parcel);
    }
    ...
    private static void G(Parcel parcel, int i10, int i11, int i12) {
        ...
        throw new C0356a("Expected size " + i12 + " got " + i11 + " (0x" + Integer.toHexString(i11) + ")", parcel);
    }
    ...
    private static void H(Parcel parcel, int i10, int i11) {
        ...
        throw new C0356a("Expected size " + i11 + " got " + iD + " (0x" + Integer.toHexString(iD) + ")", parcel);
    }
    ...
    public static void t(Parcel parcel, int i10) {
        ...
        throw new C0356a("Overread allowed size end=" + i10, parcel);
    }
