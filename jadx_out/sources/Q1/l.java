...
public abstract class l {
    ...
    private static final char[] f9040a = "0123456789abcdef".toCharArray();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final char[] f9041b = new char[64];

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static volatile Handler f9042c;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f9043a[Bitmap.Config.RGB_565.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f9043a[Bitmap.Config.ARGB_4444.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f9043a[Bitmap.Config.RGBA_F16.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f9043a[Bitmap.Config.ARGB_8888.ordinal()] = 5;
    ...
    public static boolean c(M1.a aVar, M1.a aVar2) {
        return aVar == null ? aVar2 == null : aVar.F(aVar2);
    }
    ...
    public static int j(Bitmap.Config config) {
        ...
        int i10 = a.f9043a[config.ordinal()];
        int i11 = 1;
        if (i10 != 1) {
            i11 = 2;
            if (i10 != 2 && i10 != 3) {
    ...
    private static Handler l() {
        if (f9042c == null) {
            synchronized (l.class) {
                try {
                    if (f9042c == null) {
                        f9042c = new Handler(Looper.getMainLooper());
                    }
                } finally {
                }
            }
