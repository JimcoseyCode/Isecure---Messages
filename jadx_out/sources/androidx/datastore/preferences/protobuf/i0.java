...
abstract class i0 {
    ...
    private static final Unsafe f16880a = A();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Class f16881b = AbstractC1711d.b();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final boolean f16882c = m(Long.TYPE);

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final boolean f16883d = m(Integer.TYPE);

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final e f16884e = y();

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final boolean f16885f = Q();

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static final boolean f16886g = P();

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    static final long f16887h;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private static final long f16888i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    private static final long f16889j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    private static final long f16890k;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    private static final long f16891l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    private static final long f16892m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    private static final long f16893n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    private static final long f16894o;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    private static final long f16895p;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    private static final long f16896q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    private static final long f16897r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    private static final long f16898s;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    private static final long f16899t;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    private static final long f16900u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    private static final int f16901v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    static final boolean f16902w;
    ...
    private static final class b extends e {
        ...
        public boolean c(Object obj, long j10) {
            return i0.f16902w ? i0.q(obj, j10) : i0.r(obj, j10);
        }
    ...
    private static final class d extends e {
        ...
        @Override // androidx.datastore.preferences.protobuf.i0.e
        public boolean c(Object obj, long j10) {
            return this.f16903a.getBoolean(obj, j10);
        }

        @Override // androidx.datastore.preferences.protobuf.i0.e
        public double d(Object obj, long j10) {
            return this.f16903a.getDouble(obj, j10);
        }

        @Override // androidx.datastore.preferences.protobuf.i0.e
        public float e(Object obj, long j10) {
            return this.f16903a.getFloat(obj, j10);
        }

        @Override // androidx.datastore.preferences.protobuf.i0.e
        public void j(Object obj, long j10, boolean z10) {
            this.f16903a.putBoolean(obj, j10, z10);
        }

        @Override // androidx.datastore.preferences.protobuf.i0.e
        public void k(Object obj, long j10, byte b10) {
            this.f16903a.putByte(obj, j10, b10);
        }

        @Override // androidx.datastore.preferences.protobuf.i0.e
        public void l(Object obj, long j10, double d10) {
            this.f16903a.putDouble(obj, j10, d10);
        }

        @Override // androidx.datastore.preferences.protobuf.i0.e
        public void m(Object obj, long j10, float f10) {
            this.f16903a.putFloat(obj, j10, f10);
        }
        ...
        public boolean q() {
            ...
            try {
                Class<?> cls = this.f16903a.getClass();
    ...
    private static abstract class e {
        ...
        public final int a(Class cls) {
            return this.f16903a.arrayBaseOffset(cls);
        }

        public final int b(Class cls) {
            return this.f16903a.arrayIndexScale(cls);
        }
        ...
        public final int f(Object obj, long j10) {
            return this.f16903a.getInt(obj, j10);
        }

        public final long g(Object obj, long j10) {
            return this.f16903a.getLong(obj, j10);
        }

        public final Object h(Object obj, long j10) {
            return this.f16903a.getObject(obj, j10);
        }

        public final long i(Field field) {
            return this.f16903a.objectFieldOffset(field);
        }
        ...
        public final void n(Object obj, long j10, int i10) {
            this.f16903a.putInt(obj, j10, i10);
        }

        public final void o(Object obj, long j10, long j11) {
            this.f16903a.putLong(obj, j10, j11);
        }

        public final void p(Object obj, long j10, Object obj2) {
            this.f16903a.putObject(obj, j10, obj2);
        }

        public boolean q() {
            Unsafe unsafe = this.f16903a;
            if (unsafe == null) {
                return false;
            }
            try {
    ...
    static {
        ...
        f16887h = j10;
        f16888i = j(boolean[].class);
        f16889j = k(boolean[].class);
        f16890k = j(int[].class);
        f16891l = k(int[].class);
        f16892m = j(long[].class);
        f16893n = k(long[].class);
        f16894o = j(float[].class);
        f16895p = k(float[].class);
        f16896q = j(double[].class);
        f16897r = k(double[].class);
        f16898s = j(Object[].class);
        f16899t = k(Object[].class);
        f16900u = o(l());
        f16901v = (int) (j10 & 7);
        f16902w = ByteOrder.nativeOrder() == ByteOrder.BIG_ENDIAN;
    }
    ...
    static void H(byte[] bArr, long j10, byte b10) {
        f16884e.k(bArr, f16887h + j10, b10);
    }
    ...
    static Object i(Class cls) {
        try {
            return f16880a.allocateInstance(cls);
    ...
    public static Field l() {
        Field fieldN;
        if (AbstractC1711d.c() && (fieldN = n(Buffer.class, "effectiveDirectAddress")) != null) {
            return fieldN;
        }
    ...
    private static long o(Field field) {
        e eVar;
        if (field == null || (eVar = f16884e) == null) {
            return -1L;
        }
        return eVar.i(field);
    }
    ...
    static double u(Object obj, long j10) {
        return f16884e.d(obj, j10);
    }

    static float v(Object obj, long j10) {
        return f16884e.e(obj, j10);
    }

    static int w(Object obj, long j10) {
        return f16884e.f(obj, j10);
    }

    static long x(Object obj, long j10) {
        return f16884e.g(obj, j10);
    }

    private static e y() {
        Unsafe unsafe = f16880a;
        if (unsafe == null) {
            return null;
        }
        if (!AbstractC1711d.c()) {
