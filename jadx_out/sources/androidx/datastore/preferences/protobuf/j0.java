...
abstract class j0 {
    ...
    private static final b f16906a;

    /* JADX INFO: compiled from: r8-map-id-061e463ed15b965618257332b2076f08a8430850913ea9e10e0349edf4e95e68 */
    private static class a {
        /* JADX INFO: Access modifiers changed from: private */
        public static void h(byte b10, byte b11, byte b12, byte b13, char[] cArr, int i10) throws C1728v {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static void j(byte b10, byte b11, byte b12, char[] cArr, int i10) throws C1728v {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static void k(byte b10, byte b11, char[] cArr, int i10) throws C1728v {
            if (b10 < -62 || m(b11)) {
                throw C1728v.d();
            }
    ...
    static final class c extends b {
        ...
        String a(byte[] bArr, int i10, int i11) throws C1728v {
        ...
        int b(String str, byte[] bArr, int i10, int i11) {
            ...
            while (i15 < length) {
                ...
                if (cCharAt2 < 128 && i16 < i14) {
                    ...
                    i16 += 2;
                    bArr[i17] = (byte) ((cCharAt2 & '?') | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
                } else {
                    ...
                    i16 += 3;
                    bArr[i20] = (byte) ((cCharAt2 & '?') | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
                }
                i15++;
            }
            return i16;
    ...
    static final class e extends b {
        ...
        @Override // androidx.datastore.preferences.protobuf.j0.b
        String a(byte[] bArr, int i10, int i11) throws C1728v {
            Charset charset = AbstractC1727u.f17040b;
                ...
                if (cCharAt2 < 128 && j13 < j14) {
                    ...
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || j13 > j14 - 3) {
                        ...
                        if (i14 != length) {
                            ...
                            if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                i0.H(bArr, j13, (byte) ((codePoint >>> 18) | 240));
                                i0.H(bArr, j13 + j11, (byte) (((codePoint >>> 12) & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT));
                                long j15 = j13 + 3;
                                i0.H(bArr, j13 + 2, (byte) (((codePoint >>> 6) & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT));
                                j13 += 4;
                                i0.H(bArr, j15, (byte) ((codePoint & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT));
                                i13 = i14;
                            } else {
                                i13 = i14;
                            }
                    ...
                    i0.H(bArr, j13, (byte) ((cCharAt2 >>> '\f') | 480));
                    long j16 = j13 + 2;
                    j12 = j14;
                    i0.H(bArr, j13 + j11, (byte) (((cCharAt2 >>> 6) & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT));
                    j13 += 3;
                    i0.H(bArr, j16, (byte) ((cCharAt2 & '?') | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT));
                } else {
                    j11 = j10;
                    long j17 = j13 + j11;
                    i0.H(bArr, j13, (byte) ((cCharAt2 >>> 6) | 960));
                    j13 += 2;
                    i0.H(bArr, j17, (byte) ((cCharAt2 & '?') | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT));
                    j12 = j14;
                }
                i13++;
                j10 = j11;
    ...
    static {
        f16906a = (!e.c() || AbstractC1711d.c()) ? new c() : new e();
    }

    static String a(byte[] bArr, int i10, int i11) {
        return f16906a.a(bArr, i10, i11);
    }

    static int b(String str, byte[] bArr, int i10, int i11) {
        return f16906a.b(str, bArr, i10, i11);
    }
