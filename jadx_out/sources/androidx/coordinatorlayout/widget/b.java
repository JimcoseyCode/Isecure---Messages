...
public abstract class b {
    ...
    private static final ThreadLocal f16268a = new ThreadLocal();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f16269b = new ThreadLocal();
    ...
    static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f16268a;
        ...
        ThreadLocal threadLocal2 = f16269b;
