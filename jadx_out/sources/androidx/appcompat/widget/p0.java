...
public class p0 extends W {
    ...
    private final WeakReference f15071b;

    public p0(Context context, Resources resources) {
        super(resources);
        this.f15071b = new WeakReference(context);
    }
    ...
    public Drawable getDrawable(int i10) {
        Context context = (Context) this.f15071b.get();
        return context != null ? V.g().s(context, this, i10) : a(i10);
    }
