...
public class FileProvider extends ContentProvider {
    ...
    static class c implements b {
        ...
        private final HashMap f16432b = new HashMap();
        ...
        private boolean b(String str, String str2) {
            return FileProvider.h(str).startsWith(FileProvider.h(str2) + '/');
        }
        ...
        void a(String str, File file) {
            ...
            try {
                this.f16432b.put(str, file.getCanonicalFile());
        ...
        public File getFileForUri(Uri uri) {
            ...
            File file = (File) this.f16432b.get(strDecode);
            if (file == null) {
        ...
        public Uri getUriForFile(File file) {
            try {
                ...
                for (Map.Entry entry2 : this.f16432b.entrySet()) {
                ...
                return new Uri.Builder().scheme("content").authority(this.f16431a).encodedPath(Uri.encode((String) entry.getKey()) + '/' + Uri.encode(path2.endsWith("/") ? canonicalPath.substring(path2.length()) : canonicalPath.substring(path2.length() + 1), "/")).build();
            } catch (IOException unused) {
    ...
    private b d() {
        ...
        synchronized (this.mLock) {
            try {
                H0.c.d(this.mAuthority, "mAuthority is null. Did you override attachInfo and did not call super.attachInfo()?");
    ...
    private static b g(Context context, String str, int i10) throws XmlPullParserException, IOException {
        c cVar = new c(str);
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                if (externalStorageDirectory != null) {
                    cVar.a(attributeValue, a(externalStorageDirectory, attributeValue2));
                }
            }
        }
    }
    ...
    public static Uri getUriForFile(Context context, String str, File file) {
        return e(context, str, 0).getUriForFile(file);
    }
    ...
    public int delete(Uri uri, String str, String[] strArr) {
        return d().getFileForUri(uri).delete() ? 1 : 0;
    }

    @Override // android.content.ContentProvider
    public String getType(Uri uri) {
        File fileForUri = d().getFileForUri(uri);
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) throws FileNotFoundException {
        return ParcelFileDescriptor.open(d().getFileForUri(uri), f(str));
    }
