...
public abstract class i {
    ...
    private static class e implements ActionMode.Callback {
        ...
        private final ActionMode.Callback f16702a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final TextView f16703b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private Class f16704c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        private Method f16705d;
        ...
        private void g(Menu menu) {
            Context context = this.f16703b.getContext();
            ...
            if (!z10) {
                ...
                try {
                    ...
                    this.f16704c = cls2;
                    this.f16705d = cls2.getDeclaredMethod("removeItemAt", cls);
                    this.f16706e = true;
            ...
            try {
                Method declaredMethod = (this.f16706e && this.f16704c.isInstance(menu)) ? this.f16705d : menu.getClass().getDeclaredMethod("removeItemAt", cls);
                ...
                for (int i10 = 0; i10 < listC.size(); i10++) {
                    ...
                    menu.add(0, 0, i10 + 100, resolveInfo.loadLabel(packageManager)).setIntent(b(resolveInfo, this.f16703b)).setShowAsAction(1);
                }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f16702a.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f16702a.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public void onDestroyActionMode(ActionMode actionMode) {
            this.f16702a.onDestroyActionMode(actionMode);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            g(menu);
            return this.f16702a.onPrepareActionMode(actionMode, menu);
        }
    }
    ...
    public static l.a e(TextView textView) {
        ...
        l.a.C0046a c0046a = new l.a.C0046a(new TextPaint(textView.getPaint()));
        c0046a.b(a.a(textView));
        c0046a.c(a.b(textView));
        c0046a.d(d(textView));
        return c0046a.a();
    }
    ...
    public static void n(TextView textView, l.a aVar) {
