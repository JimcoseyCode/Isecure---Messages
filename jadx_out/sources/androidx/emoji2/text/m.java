...
abstract class m {
    ...
    private static class a implements c {
        ...
        private final ByteBuffer f17160a;

        a(ByteBuffer byteBuffer) {
            this.f17160a = byteBuffer;
            byteBuffer.order(ByteOrder.BIG_ENDIAN);
        }

        @Override // androidx.emoji2.text.m.c
        public int a() {
            return this.f17160a.getInt();
        }

        @Override // androidx.emoji2.text.m.c
        public void b(int i10) {
            ByteBuffer byteBuffer = this.f17160a;
            byteBuffer.position(byteBuffer.position() + i10);
        }

        @Override // androidx.emoji2.text.m.c
        public long c() {
            return m.c(this.f17160a.getInt());
        }

        @Override // androidx.emoji2.text.m.c
        public long getPosition() {
            return this.f17160a.position();
        }

        @Override // androidx.emoji2.text.m.c
        public int readUnsignedShort() {
            return m.d(this.f17160a.getShort());
        }
    }
