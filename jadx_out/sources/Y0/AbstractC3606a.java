...
public abstract class AbstractC3606a {
    ...
    public static void a(Drawable drawable, Resources.Theme theme) {
        C0373a.a(drawable, theme);
    }

    public static boolean b(Drawable drawable) {
        return C0373a.b(drawable);
    }
    ...
    public static void g(Drawable drawable, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        C0373a.d(drawable, resources, xmlPullParser, attributeSet, theme);
    }
    ...
    public static void n(Drawable drawable, int i10) {
        C0373a.g(drawable, i10);
    }

    public static void o(Drawable drawable, ColorStateList colorStateList) {
        C0373a.h(drawable, colorStateList);
    }

    public static void p(Drawable drawable, PorterDuff.Mode mode) {
        C0373a.i(drawable, mode);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static Drawable q(Drawable drawable) {
        return drawable instanceof InterfaceC3608c ? ((InterfaceC3608c) drawable).b() : drawable;
    }
