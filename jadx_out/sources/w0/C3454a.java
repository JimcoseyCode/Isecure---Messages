...
public class C3454a {
    ...
    private final float f33030a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final float f33031b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final float f33032c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final float f33033d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private final float f33034e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private final float f33035f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private final float f33036g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private final float f33037h;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private final float f33038i;

    C3454a(float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, float f18) {
        this.f33030a = f10;
        this.f33031b = f11;
        this.f33032c = f12;
        this.f33033d = f13;
    ...
    private static C3454a b(float f10, float f11, float f12) {
        float f13 = 100.0f;
        float f14 = 1000.0f;
        float f15 = 0.0f;
        C3454a c3454a = null;
        ...
        while (Math.abs(f15 - f13) > 0.01f) {
            ...
            float fB = AbstractC3455b.b(iP);
            float fAbs = Math.abs(f12 - fB);
            if (fAbs < 0.2f) {
                C3454a c3454aC = c(iP);
                float fA = c3454aC.a(e(c3454aC.k(), c3454aC.i(), f10));
                if (fA <= 1.0f) {
                    c3454a = c3454aC;
                    f14 = fAbs;
                    f16 = fA;
    ...
    static C3454a c(int i10) {
        float[] fArr = new float[7];
        float[] fArr2 = new float[3];
        d(i10, l.f33075k, fArr, fArr2);
        return new C3454a(fArr2[0], fArr2[1], fArr[0], fArr[1], fArr[2], fArr[3], fArr[4], fArr[5], fArr[6]);
    }

    static void d(int i10, l lVar, float[] fArr, float[] fArr2) {
        AbstractC3455b.f(i10, fArr2);
        float[][] fArr3 = AbstractC3455b.f33039a;
        float f10 = fArr2[0];
        float[] fArr4 = fArr3[0];
        ...
        float fSqrt2 = ((float) Math.sqrt((r4 * lVar.b()) / (lVar.a() + 4.0f))) * 50.0f;
    ...
    private static C3454a e(float f10, float f11, float f12) {
        return f(f10, f11, f12, l.f33075k);
    }

    private static C3454a f(float f10, float f11, float f12, l lVar) {
    ...
    static int n(float f10, float f11, float f12, l lVar) {
        ...
        while (Math.abs(f13 - f11) >= 0.4f) {
            ...
            if (!z10) {
                ...
                if (c3454aB != null) {
                    return c3454aB.o(lVar);
                }
                f14 = ((f11 - f13) / 2.0f) + f13;
                z10 = false;
            }
        }
        return c3454a == null ? AbstractC3455b.a(f12) : c3454a.o(lVar);
    }

    float a(C3454a c3454a) {
        float fL = l() - c3454a.l();
        float fG = g() - c3454a.g();
        float fH = h() - c3454a.h();
    ...
    int o(l lVar) {
        ...
        float[][] fArr = AbstractC3455b.f33040b;
        float[] fArr2 = fArr[0];
        float f20 = (fArr2[0] * f17) + (fArr2[1] * f18) + (fArr2[2] * f19);
        float[] fArr3 = fArr[1];
        float f21 = (fArr3[0] * f17) + (fArr3[1] * f18) + (fArr3[2] * f19);
        float[] fArr4 = fArr[2];
        return AbstractC3516d.b(f20, f21, (f17 * fArr4[0]) + (f18 * fArr4[1]) + (f19 * fArr4[2]));
    }
