...
public class DateValidatorPointBackward implements CalendarConstraints.DateValidator {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof DateValidatorPointBackward) && this.f23154g == ((DateValidatorPointBackward) obj).f23154g;
    }

    public int hashCode() {
        return Arrays.hashCode(new Object[]{Long.valueOf(this.f23154g)});
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i10) {
        parcel.writeLong(this.f23154g);
    }
