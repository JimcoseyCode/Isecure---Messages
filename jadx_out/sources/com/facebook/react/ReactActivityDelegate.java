...
public class ReactActivityDelegate {
    ...
    protected Context getContext() {
        return (Context) AbstractC3007a.c(this.mActivity);
    }
    ...
    public void onCreate(Bundle bundle) {
        B3.a.o(0L, "ReactActivityDelegate.onCreate::init", new Runnable() { // from class: com.facebook.react.f
            @Override // java.lang.Runnable
            public final void run() {
                this.f20391g.lambda$onCreate$0();
            }
        });
    }
    ...
    public void onRequestPermissionsResult(final int i10, final String[] strArr, final int[] iArr) {
        ...
        Callback callback = new Callback() { // from class: com.facebook.react.g
            ...
            public final void invoke(Object[] objArr) {
                this.f20395g.lambda$onRequestPermissionsResult$1(i10, strArr, iArr, objArr);
            }
        };
        if (getFabricEnabled()) {
