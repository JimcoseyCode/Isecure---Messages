...
public final class AdditionAnimatedNode extends ValueAnimatedNode {
    ...
    public String prettyPrint$ReactAndroid_release() {
        return "AdditionAnimatedNode[" + this.tag + "]: input nodes: " + AbstractC2793j.Z(this.inputNodes, null, null, null, 0, null, null, 63, null) + " - super: " + super.prettyPrint$ReactAndroid_release();
    }
