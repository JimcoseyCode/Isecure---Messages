...
public final class ReactInstanceManagerBuilder {
    ...
    /* JADX INFO: compiled from: r8-map-id-061e463ed15b965618257332b2076f08a8430850913ea9e10e0349edf4e95e68 */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\b\u0082\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Lcom/facebook/react/ReactInstanceManagerBuilder$Companion;", PointerEventHelper.POINTER_TYPE_UNKNOWN, "<init>", "()V", "TAG", PointerEventHelper.POINTER_TYPE_UNKNOWN, "ReactAndroid_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    private final JavaScriptExecutorFactory getDefaultJSExecutorFactory(String appName, String deviceName, Context applicationContext) {
        ...
        try {
            ...
            AbstractC2325a.m(TAG, "Unable to load Hermes. Your application is not built correctly and will fail to execute");
            return null;
        }
    }
    ...
    public final ReactInstanceManager build() {
        ...
        return new ReactInstanceManager(application, activity, defaultHardwareBackBtnHandler, javaScriptExecutorFactory, jSBundleLoaderCreateAssetLoader, str2, list, z10, devSupportManagerFactory, z11, z12, notThreadSafeBridgeIdleDebugListener, lifecycleState, this.jsExceptionHandler, this.redBoxHandler, this.lazyViewManagersEnabled, this.devBundleDownloadListener, this.minNumShakes, this.minTimeLeftInFrameForNonBatchedOperationMs, this.uiManagerProvider, this.customPackagerCommandHandlers, this.tmmDelegateBuilder, this.surfaceDelegateFactory, this.devLoadingViewManager, this.choreographerProvider, this.pausedInDebuggerOverlayManager);
    }
    ...
    public final ReactInstanceManagerBuilder setBridgeIdleDebugListener(NotThreadSafeBridgeIdleDebugListener bridgeIdleDebugListener) {
        AbstractC2855l.g(bridgeIdleDebugListener, "bridgeIdleDebugListener");
    ...
    public final ReactInstanceManagerBuilder setDefaultHardwareBackBtnHandler(DefaultHardwareBackBtnHandler defaultHardwareBackBtnHandler) {
        AbstractC2855l.g(defaultHardwareBackBtnHandler, "defaultHardwareBackBtnHandler");
    ...
    public final ReactInstanceManagerBuilder setInitialLifecycleState(LifecycleState initialLifecycleState) {
        AbstractC2855l.g(initialLifecycleState, "initialLifecycleState");
    ...
    public final ReactInstanceManagerBuilder setJSBundleFile(String jsBundleFile) {
        AbstractC2855l.g(jsBundleFile, "jsBundleFile");
        if (!P8.q.K(jsBundleFile, "assets://", false, 2, null)) {
