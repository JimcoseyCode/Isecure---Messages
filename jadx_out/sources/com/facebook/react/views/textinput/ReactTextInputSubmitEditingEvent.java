...
public final class ReactTextInputSubmitEditingEvent extends Event<ReactTextInputSubmitEditingEvent> {
    ...
    public ReactTextInputSubmitEditingEvent(int i10, int i11, String text) {
        super(i10, i11);
