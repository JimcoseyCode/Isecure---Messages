...
public final class ReactSwitch extends a0 {
    ...
    public final void setThumbColor(Integer color) {
        ...
        AbstractC2855l.f(thumbDrawable, "getThumbDrawable(...)");
        ...
        AbstractC2855l.e(background, "null cannot be cast to non-null type android.graphics.drawable.RippleDrawable");
    ...
    public final void setTrackColor(Integer color) {
        ...
        AbstractC2855l.f(trackDrawable, "getTrackDrawable(...)");
        setColor(trackDrawable, color);
    }

    public final void setTrackColorForFalse(Integer color) {
        if (AbstractC2855l.b(color, this.trackColorForFalse)) {
            return;
        }
    ...
    public final void setTrackColorForTrue(Integer color) {
        if (AbstractC2855l.b(color, this.trackColorForTrue)) {
            return;
        }
