...
@Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0000\u0018\u00002\u00020\u0001B\u0017\u0012\u000e\u0010\u0004\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00030\u0002¢\u0006\u0004\b\u0005\u0010\u0006J\u001f\u0010\f\u001a\u00020\u000b2\u0006\u0010\b\u001a\u00020\u00072\u0006\u0010\n\u001a\u00020\tH\u0016¢\u0006\u0004\b\f\u0010\rJ\u000f\u0010\u000e\u001a\u00020\u000bH\u0016¢\u0006\u0004\b\u000e\u0010\u000fR\u001c\u0010\u0004\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00030\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0004\u0010\u0010R\u0018\u0010\u0012\u001a\u0004\u0018\u00010\u00118\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013¨\u0006\u0014"}, d2 = {"Lcom/facebook/react/devsupport/PausedInDebuggerOverlayDialogManager;", "Lcom/facebook/react/devsupport/interfaces/PausedInDebuggerOverlayManager;", "LH0/i;", "Landroid/content/Context;", "contextSupplier", "<init>", "(LH0/i;)V", PointerEventHelper.POINTER_TYPE_UNKNOWN, "message", "Lcom/facebook/react/devsupport/interfaces/DevSupportManager$PausedInDebuggerOverlayCommandListener;", "listener", "Li7/B;", "showPausedInDebuggerOverlay", "(Ljava/lang/String;Lcom/facebook/react/devsupport/interfaces/DevSupportManager$PausedInDebuggerOverlayCommandListener;)V", "hidePausedInDebuggerOverlay", "()V", "LH0/i;", "Landroid/app/Dialog;", "pausedInDebuggerDialog", "Landroid/app/Dialog;", "ReactAndroid_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class PausedInDebuggerOverlayDialogManager implements PausedInDebuggerOverlayManager {
    private final H0.i contextSupplier;
    private Dialog pausedInDebuggerDialog;

    public PausedInDebuggerOverlayDialogManager(H0.i contextSupplier) {
        AbstractC2855l.g(contextSupplier, "contextSupplier");
    ...
    public static final void showPausedInDebuggerOverlay$lambda$3(PausedInDebuggerOverlayDialogManager pausedInDebuggerOverlayDialogManager, String str, final DevSupportManager.PausedInDebuggerOverlayCommandListener pausedInDebuggerOverlayCommandListener) {
        ...
        viewInflate.findViewById(R.id.button).setOnClickListener(new View.OnClickListener() { // from class: com.facebook.react.devsupport.c0
        ...
        if (window != null) {
            ...
            AbstractC2855l.f(attributes, "getAttributes(...)");
    ...
    public void hidePausedInDebuggerOverlay() {
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.e0
            ...
            public final void run() {
                PausedInDebuggerOverlayDialogManager.hidePausedInDebuggerOverlay$lambda$4(this.f20349g);
            }
        });
    }
    ...
    public void showPausedInDebuggerOverlay(final String message, final DevSupportManager.PausedInDebuggerOverlayCommandListener listener) {
        ...
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.d0
            @Override // java.lang.Runnable
            public final void run() {
                PausedInDebuggerOverlayDialogManager.showPausedInDebuggerOverlay$lambda$3(this.f20343g, message, listener);
            }
        });
    }
}
