...
@Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0011\n\u0002\u0010\b\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0007\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0081@\u0018\u00002\u00020\u0001B\u0019\u0012\u0010\b\u0003\u0010\u0002\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00040\u0003¢\u0006\u0004\b\u0005\u0010\u0006J\u001d\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\u00042\u0006\u0010\r\u001a\u00020\u000e¢\u0006\u0004\b\u000f\u0010\u0010J\u001a\u0010\u0011\u001a\u00020\u00122\b\u0010\u0013\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\u0014\u0010\u0015J\u0010\u0010\u0016\u001a\u00020\u0004HÖ\u0001¢\u0006\u0004\b\u0017\u0010\u0018J\u0010\u0010\u0019\u001a\u00020\u001aHÖ\u0001¢\u0006\u0004\b\u001b\u0010\u001cR\u001b\u0010\u0002\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00040\u0003¢\u0006\n\n\u0002\u0010\t\u001a\u0004\b\u0007\u0010\b\u0088\u0001\u0002¨\u0006\u001d"}, d2 = {"Lcom/facebook/react/uimanager/style/BorderColors;", PointerEventHelper.POINTER_TYPE_UNKNOWN, "edgeColors", PointerEventHelper.POINTER_TYPE_UNKNOWN, PointerEventHelper.POINTER_TYPE_UNKNOWN, "constructor-impl", "([Ljava/lang/Integer;)[Ljava/lang/Integer;", "getEdgeColors", "()[Ljava/lang/Integer;", "[Ljava/lang/Integer;", "resolve", "Lcom/facebook/react/uimanager/style/ColorEdges;", ViewProps.LAYOUT_DIRECTION, "context", "Landroid/content/Context;", "resolve-impl", "([Ljava/lang/Integer;ILandroid/content/Context;)Lcom/facebook/react/uimanager/style/ColorEdges;", "equals", PointerEventHelper.POINTER_TYPE_UNKNOWN, "other", "equals-impl", "([Ljava/lang/Integer;Ljava/lang/Object;)Z", "hashCode", "hashCode-impl", "([Ljava/lang/Integer;)I", "toString", PointerEventHelper.POINTER_TYPE_UNKNOWN, "toString-impl", "([Ljava/lang/Integer;)Ljava/lang/String;", "ReactAndroid_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class BorderColors {
    ...
    public static final /* synthetic */ BorderColors m8boximpl(Integer[] numArr) {
        return new BorderColors(numArr);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static Integer[] m9constructorimpl(Integer[] edgeColors) {
        AbstractC2855l.g(edgeColors, "edgeColors");
        return edgeColors;
    }

    /* JADX INFO: renamed from: constructor-impl$default, reason: not valid java name */
    public static /* synthetic */ Integer[] m10constructorimpl$default(Integer[] numArr, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i10 & 1) != 0) {
            numArr = new Integer[LogicalEdge.values().length];
        }
        return m9constructorimpl(numArr);
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m11equalsimpl(Integer[] numArr, Object obj) {
        return (obj instanceof BorderColors) && AbstractC2855l.b(numArr, ((BorderColors) obj).m16unboximpl());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m12equalsimpl0(Integer[] numArr, Integer[] numArr2) {
        return AbstractC2855l.b(numArr, numArr2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m13hashCodeimpl(Integer[] numArr) {
        return Arrays.hashCode(numArr);
    }

    /* JADX INFO: renamed from: resolve-impl, reason: not valid java name */
    public static final ColorEdges m14resolveimpl(Integer[] numArr, int i10, Context context) {
    ...
    public static String m15toStringimpl(Integer[] numArr) {
        return "BorderColors(edgeColors=" + Arrays.toString(numArr) + ")";
    }

    public boolean equals(Object obj) {
        return m11equalsimpl(this.edgeColors, obj);
    }
    ...
    public int hashCode() {
        return m13hashCodeimpl(this.edgeColors);
    }

    public String toString() {
        return m15toStringimpl(this.edgeColors);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ Integer[] m16unboximpl() {
        return this.edgeColors;
    }
}
