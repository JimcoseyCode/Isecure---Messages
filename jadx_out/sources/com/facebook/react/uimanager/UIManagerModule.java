...
public class UIManagerModule extends ReactContextBaseJavaModule implements OnBatchCompleteListener, LifecycleEventListener, UIManager {
    ...
    static {
        ...
        DEBUG = C3006c.a().b(C3049a.f30620g);
    }
    ...
    private static Map<String, Object> createConstants(ViewManagerResolver viewManagerResolver) {
        ...
        B3.b.a(0L, "CreateUIManagerConstants").b("Lazy", Boolean.TRUE).c();
        try {
    ...
    public void createView(int i10, String str, int i11, ReadableMap readableMap) {
        if (DEBUG) {
            ...
            AbstractC2325a.b(ReactConstants.TAG, str2);
            C3006c.a().a(C3049a.f30620g, str2);
        }
    ...
    public void invalidateNodeLayout(int i10) {
        ReactShadowNode reactShadowNodeResolveShadowNode = this.mUIImplementation.resolveShadowNode(i10);
        if (reactShadowNodeResolveShadowNode != null) {
            ...
            AbstractC2325a.I(ReactConstants.TAG, "Warning : attempted to dirty a non-existent react shadow node. reactTag=" + i10);
        }
    }
    ...
    public void onBatchComplete() {
        ...
        this.mBatchId = i10 + 1;
        B3.b.a(0L, "onBatchCompleteUI").a("BatchId", i10).c();
    ...
    public <T extends View> int addRootView(T t10, WritableMap writableMap) {
        B3.a.c(0L, "UIManagerModule.addRootView");
    ...
    public static WritableMap getConstantsForViewManager(ViewManager viewManager, Map<String, Object> map) {
        B3.b.a(0L, "UIManagerModule.getConstantsForViewManager").b("ViewManager", viewManager.getName()).b("Lazy", Boolean.TRUE).c();
        try {
