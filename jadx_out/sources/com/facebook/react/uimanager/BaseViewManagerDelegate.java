...
@Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\b&\u0018\u0000*\b\b\u0000\u0010\u0002*\u00020\u0001*\u0016\b\u0001\u0010\u0005*\u0010\u0012\u0004\u0012\u00028\u0000\u0012\u0006\b\u0001\u0012\u00020\u00040\u00032\b\u0012\u0004\u0012\u00028\u00000\u0006B\u000f\u0012\u0006\u0010\u0007\u001a\u00028\u0001¢\u0006\u0004\b\b\u0010\tJ)\u0010\u0010\u001a\u00020\u000f2\u0006\u0010\n\u001a\u00028\u00002\u0006\u0010\f\u001a\u00020\u000b2\b\u0010\u000e\u001a\u0004\u0018\u00010\rH\u0016¢\u0006\u0004\b\u0010\u0010\u0011J'\u0010\u0015\u001a\u00020\u000f2\u0006\u0010\n\u001a\u00028\u00002\u0006\u0010\u0012\u001a\u00020\u000b2\u0006\u0010\u0014\u001a\u00020\u0013H\u0016¢\u0006\u0004\b\u0015\u0010\u0016R\u0014\u0010\u0007\u001a\u00028\u00018\u0004X\u0085\u0004¢\u0006\u0006\n\u0004\b\u0007\u0010\u0017¨\u0006\u0018"}, d2 = {"Lcom/facebook/react/uimanager/BaseViewManagerDelegate;", "Landroid/view/View;", "T", "Lcom/facebook/react/uimanager/BaseViewManager;", "Lcom/facebook/react/uimanager/LayoutShadowNode;", "U", "Lcom/facebook/react/uimanager/ViewManagerDelegate;", "mViewManager", "<init>", "(Lcom/facebook/react/uimanager/BaseViewManager;)V", "view", PointerEventHelper.POINTER_TYPE_UNKNOWN, "propName", PointerEventHelper.POINTER_TYPE_UNKNOWN, "value", "Li7/B;", "setProperty", "(Landroid/view/View;Ljava/lang/String;Ljava/lang/Object;)V", "commandName", "Lcom/facebook/react/bridge/ReadableArray;", "args", "receiveCommand", "(Landroid/view/View;Ljava/lang/String;Lcom/facebook/react/bridge/ReadableArray;)V", "Lcom/facebook/react/uimanager/BaseViewManager;", "ReactAndroid_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
public abstract class BaseViewManagerDelegate<T extends View, U extends BaseViewManager<T, ? extends LayoutShadowNode>> implements ViewManagerDelegate<T> {
    ...
    public BaseViewManagerDelegate(U mViewManager) {
        AbstractC2855l.g(mViewManager, "mViewManager");
        ...
        switch (propName.hashCode()) {
            ...
            case -1471148380:
                if (propName.equals(ViewProps.OUTLINE_WIDTH)) {
                    ...
                    this.mViewManager.setOutlineWidth(view, d12 != null ? (float) d12.doubleValue() : com.facebook.yoga.g.f20769b);
                    break;
                }
                break;
            case -1351902487:
            ...
            case -1228066334:
                if (propName.equals(ViewProps.BORDER_TOP_LEFT_RADIUS)) {
                    ...
                    this.mViewManager.setBorderTopLeftRadius(view, d14 != null ? (float) d14.doubleValue() : com.facebook.yoga.g.f20769b);
                    break;
                }
                break;
            case -1219666915:
            ...
            case 333432965:
                if (propName.equals(ViewProps.BORDER_TOP_RIGHT_RADIUS)) {
                    ...
                    this.mViewManager.setBorderTopRightRadius(view, d20 != null ? (float) d20.doubleValue() : com.facebook.yoga.g.f20769b);
                    break;
                }
                break;
            case 581268560:
                if (propName.equals(ViewProps.BORDER_BOTTOM_LEFT_RADIUS)) {
                    ...
                    this.mViewManager.setBorderBottomLeftRadius(view, d21 != null ? (float) d21.doubleValue() : com.facebook.yoga.g.f20769b);
                    break;
                }
                break;
            case 588239831:
                if (propName.equals(ViewProps.BORDER_BOTTOM_RIGHT_RADIUS)) {
                    ...
                    this.mViewManager.setBorderBottomRightRadius(view, d22 != null ? (float) d22.doubleValue() : com.facebook.yoga.g.f20769b);
                    break;
                }
                break;
            case 743055051:
            ...
            case 1349188574:
                if (propName.equals(ViewProps.BORDER_RADIUS)) {
                    ...
                    this.mViewManager.setBorderRadius(view, d23 != null ? (float) d23.doubleValue() : com.facebook.yoga.g.f20769b);
                    break;
                }
                break;
            case 1407295349:
                if (propName.equals(ViewProps.OUTLINE_OFFSET)) {
                    ...
                    this.mViewManager.setOutlineOffset(view, d24 != null ? (float) d24.doubleValue() : com.facebook.yoga.g.f20769b);
                    break;
                }
                break;
            case 1505602511:
