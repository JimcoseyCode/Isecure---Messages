...
public final class ViewProps {
    ...
    private static final HashSet<String> LAYOUT_ONLY_PROPS = new HashSet<>(AbstractC2800q.m(ALIGN_SELF, ALIGN_ITEMS, COLLAPSABLE, FLEX, FLEX_BASIS, FLEX_DIRECTION, FLEX_GROW, ROW_GAP, COLUMN_GAP, GAP, FLEX_SHRINK, FLEX_WRAP, JUSTIFY_CONTENT, ALIGN_CONTENT, DISPLAY, POSITION, RIGHT, TOP, BOTTOM, LEFT, START, END, "width", "height", MIN_WIDTH, MAX_WIDTH, MIN_HEIGHT, MAX_HEIGHT, MARGIN, MARGIN_VERTICAL, MARGIN_HORIZONTAL, MARGIN_LEFT, MARGIN_RIGHT, MARGIN_TOP, MARGIN_BOTTOM, MARGIN_START, MARGIN_END, PADDING, PADDING_VERTICAL, PADDING_HORIZONTAL, PADDING_LEFT, PADDING_RIGHT, PADDING_TOP, PADDING_BOTTOM, PADDING_START, PADDING_END));
    ...
    public static final boolean isLayoutOnly(ReadableMap map, String prop) {
        ...
        if (AbstractC2855l.b(POINTER_EVENTS, prop)) {
            String string = map.getString(prop);
            return AbstractC2855l.b("auto", string) || AbstractC2855l.b(BOX_NONE, string);
        }
        switch (prop.hashCode()) {
            ...
            case 529642498:
                if (prop.equals(OVERFLOW)) {
                    return map.isNull(OVERFLOW) || AbstractC2855l.b(VISIBLE, map.getString(OVERFLOW));
                }
                return false;
            case 684610594:
