...
public class LayoutShadowNode extends ReactShadowNodeImpl {
    ...
    private static class MutableYogaValue {
        ...
        void setFromDynamic(Dynamic dynamic) {
            if (dynamic.isNull()) {
                ...
                this.value = com.facebook.yoga.g.f20769b;
                return;
            }
            ...
            if (strAsString.equals("auto")) {
                ...
                AbstractC2325a.I(ReactConstants.TAG, "Unknown value: " + strAsString);
                this.unit = com.facebook.yoga.w.UNDEFINED;
                this.value = com.facebook.yoga.g.f20769b;
            }
        }
    ...
    public void setAlignContent(String str) {
        ...
        switch (str) {
            ...
            case "space-evenly":
                ...
                break;
            default:
                AbstractC2325a.I(ReactConstants.TAG, "invalid value for alignContent: " + str);
                setAlignContent(com.facebook.yoga.a.FLEX_START);
                break;
        }
    }
    ...
    public void setAlignItems(String str) {
        ...
        switch (str) {
            ...
            case "space-around":
                ...
                break;
            default:
                AbstractC2325a.I(ReactConstants.TAG, "invalid value for alignItems: " + str);
                setAlignItems(com.facebook.yoga.a.STRETCH);
                break;
        }
    }
    ...
    public void setAlignSelf(String str) {
        ...
        switch (str) {
            ...
            case "space-around":
                ...
                break;
            default:
                AbstractC2325a.I(ReactConstants.TAG, "invalid value for alignSelf: " + str);
                setAlignSelf(com.facebook.yoga.a.AUTO);
                break;
        }
    }
    ...
    public void setDisplay(String str) {
        ...
        AbstractC2325a.I(ReactConstants.TAG, "invalid value for display: " + str);
        setDisplay(com.facebook.yoga.i.FLEX);
    }
    ...
    public void setFlexDirection(String str) {
        ...
        switch (str) {
            ...
            case "column-reverse":
                ...
                break;
            default:
                AbstractC2325a.I(ReactConstants.TAG, "invalid value for flexDirection: " + str);
                setFlexDirection(com.facebook.yoga.l.COLUMN);
                break;
        }
    }
    ...
    public void setFlexWrap(String str) {
        ...
        switch (str) {
            ...
            case "wrap":
                ...
                break;
            default:
                AbstractC2325a.I(ReactConstants.TAG, "invalid value for flexWrap: " + str);
                setFlexWrap(com.facebook.yoga.x.NO_WRAP);
                break;
        }
    }
    ...
    public void setJustifyContent(String str) {
        ...
        switch (str) {
            ...
            case "space-evenly":
                ...
                break;
            default:
                AbstractC2325a.I(ReactConstants.TAG, "invalid value for justifyContent: " + str);
                setJustifyContent(com.facebook.yoga.n.FLEX_START);
                break;
        }
    }
    ...
    public void setMargins(int i10, Dynamic dynamic) {
        ...
        int iMaybeTransformLeftRightToStartEnd = maybeTransformLeftRightToStartEnd(ViewProps.PADDING_MARGIN_SPACING_TYPES[i10]);
        this.mTempYogaValue.setFromDynamic(dynamic);
    ...
    public void setOverflow(String str) {
        ...
        switch (str) {
            ...
            case "visible":
                ...
                break;
            default:
                AbstractC2325a.I(ReactConstants.TAG, "invalid value for overflow: " + str);
                setOverflow(com.facebook.yoga.u.VISIBLE);
                break;
        }
    }
    ...
    public void setPosition(String str) {
        ...
        AbstractC2325a.I(ReactConstants.TAG, "invalid value for position: " + str);
        setPositionType(com.facebook.yoga.v.RELATIVE);
    }
    ...
    public void setPositionValues(int i10, Dynamic dynamic) {
        ...
        int iMaybeTransformLeftRightToStartEnd = maybeTransformLeftRightToStartEnd(new int[]{4, 5, 0, 2, 1, 3}[i10]);
        this.mTempYogaValue.setFromDynamic(dynamic);
        int i11 = AnonymousClass1.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
        if (i11 == 1 || i11 == 2) {
