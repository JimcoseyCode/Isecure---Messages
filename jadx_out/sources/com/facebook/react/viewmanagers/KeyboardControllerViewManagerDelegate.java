...
public class KeyboardControllerViewManagerDelegate<T extends View, U extends BaseViewManager<T, ? extends LayoutShadowNode> & KeyboardControllerViewManagerInterface<T>> extends BaseViewManagerDelegate<T, U> {
    ...
    public void kotlinCompat$setProperty(T t10, String str, Object obj) {
        ...
        switch (str) {
            case "enabled":
                ((KeyboardControllerViewManagerInterface) this.mViewManager).setEnabled(t10, obj != null ? ((Boolean) obj).booleanValue() : false);
                break;
            case "statusBarTranslucent":
                ((KeyboardControllerViewManagerInterface) this.mViewManager).setStatusBarTranslucent(t10, obj != null ? ((Boolean) obj).booleanValue() : false);
                break;
            case "preserveEdgeToEdge":
                ((KeyboardControllerViewManagerInterface) this.mViewManager).setPreserveEdgeToEdge(t10, obj != null ? ((Boolean) obj).booleanValue() : false);
                break;
            case "navigationBarTranslucent":
                ((KeyboardControllerViewManagerInterface) this.mViewManager).setNavigationBarTranslucent(t10, obj != null ? ((Boolean) obj).booleanValue() : false);
                break;
            default:
