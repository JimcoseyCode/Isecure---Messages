...
public class FabricUIManager implements UIManager, LifecycleEventListener, UIBlockViewResolver, SynchronousEventReceiver {
    ...
    private class DispatchUIFrameCallback extends GuardedFrameCallback {
        ...
        public void doFrameGuarded(long j10) {
            ...
            if (!this.mIsMountingEnabled) {
                AbstractC2325a.I(FabricUIManager.TAG, "Not flushing pending UI operations: exception was previously thrown");
                return;
            }
            if (FabricUIManager.this.mDestroyed) {
                AbstractC2325a.I(FabricUIManager.TAG, "Not flushing pending UI operations: FabricUIManager is destroyed");
                return;
            }
            ...
            try {
                try {
                    ...
                    AbstractC2325a.n(FabricUIManager.TAG, "Exception thrown when executing UIFrameGuarded", e10);
        ...
        public void didMountItems(List<? extends MountItem> list) {
            ...
            UiThreadUtil.getUiThreadHandler().postAtFrontOfQueue(new Runnable() { // from class: com.facebook.react.fabric.b
                ...
                public final void run() {
                    this.f20392g.lambda$didMountItems$0();
                }
            });
        }
    ...
    private long getEncodedScreenSizeWithoutVerticalInsets(int i10) {
        ...
        AbstractC2325a.K(TAG, "Couldn't get context from SurfaceMountingManager for surfaceId %d", Integer.valueOf(i10));
        return 0L;
    }
    ...
    private void scheduleMountItem(MountItem mountItem, int i10, long j10, long j11, long j12, long j13, long j14, long j15, long j16, int i11) {
        ...
        if (z11) {
            ...
            AbstractC3007a.d(batchMountItem, "BatchMountItem is null");
        ...
        if (z12) {
            AbstractC3007a.d(mountItem, "MountItem is null");
    ...
    public <T extends View> int addRootView(T t10, WritableMap writableMap) {
        ...
        if (ReactNativeFeatureFlags.enableFabricLogs()) {
            AbstractC2325a.d(str, "Starting surface for module: %s and reactTag: %d", jSModuleName, Integer.valueOf(rootViewTag));
        }
        AbstractC3007a.d(this.mBinding, "Binding in FabricUIManager is null");
    ...
    public boolean getThemeData(int i10, float[] fArr) {
        ...
        if (context == null) {
            AbstractC2325a.K(TAG, "Couldn't get context for surfaceId %d in getThemeData", Integer.valueOf(i10));
            return false;
        }
    ...
    public void invalidate() {
        String str = TAG;
        AbstractC2325a.s(str, "FabricUIManager.invalidate");
    ...
    public long measure(int i10, String str, ReadableMap readableMap, ReadableMap readableMap2, ReadableMap readableMap3, float f10, float f11, float f12, float f13) {
        ...
        if (i10 > 0) {
            ...
            AbstractC3007a.d(context, "Context in SurfaceMountingManager is null. surfaceId: " + i10);
        } else {
    ...
    public PreparedLayout prepareTextLayout(int i10, ReadableMapBuffer readableMapBuffer, ReadableMapBuffer readableMapBuffer2, float f10, float f11, float f12, float f13) {
        ...
        NativeModule nativeModule = this.mViewManagerRegistry.get("RCTText");
        return TextLayoutManager.createPreparedLayout((Context) g.g(surfaceManagerEnforced.getContext()), readableMapBuffer, readableMapBuffer2, LayoutMetricsConversions.getYogaSize(f10, f11), LayoutMetricsConversions.getYogaMeasureMode(f10, f11), LayoutMetricsConversions.getYogaSize(f12, f13), LayoutMetricsConversions.getYogaMeasureMode(f12, f13), nativeModule instanceof ReactTextViewManagerCallback ? (ReactTextViewManagerCallback) nativeModule : null);
    }
    ...
    public void setJSResponder(final int i10, final int i11, final int i12, final boolean z10) {
        this.mMountItemDispatcher.addMountItem(new MountItem() { // from class: com.facebook.react.fabric.FabricUIManager.3
            ...
            public void execute(MountingManager mountingManager) {
                ...
                AbstractC2325a.m(FabricUIManager.TAG, "setJSResponder skipped, surface no longer available [" + i10 + "]");
            }
    ...
    public <T extends View> int startSurface(T t10, String str, WritableMap writableMap, int i10, int i11) {
        ...
        if (ReactNativeFeatureFlags.enableFabricLogs()) {
            AbstractC2325a.d(TAG, "Starting surface for module: %s and reactTag: %d", str, Integer.valueOf(rootViewTag));
        }
    ...
    public void synchronouslyUpdateViewOnUIThread(int i10, ReadableMap readableMap) {
        ...
        if (ReactNativeFeatureFlags.enableFabricLogs()) {
            AbstractC2325a.d(TAG, "SynchronouslyUpdateViewOnUIThread for tag %d: %s", Integer.valueOf(i10), IS_DEVELOPMENT_ENVIRONMENT ? readableMap.toHashMap().toString() : "<hidden>");
        }
    ...
    public void updateRootLayoutSpecs(int i10, int i11, int i12, int i13, int i14) {
        ...
        if (ReactNativeFeatureFlags.enableFabricLogs()) {
            AbstractC2325a.c(TAG, "Updating Root Layout Specs for [%d]", Integer.valueOf(i10));
        }
        SurfaceMountingManager surfaceManager = this.mMountingManager.getSurfaceManager(i10);
        if (surfaceManager == null) {
        ...
        AbstractC3007a.d(this.mBinding, "Binding in FabricUIManager is null");
        this.mBinding.setConstraints(i10, LayoutMetricsConversions.getMinSize(i11), LayoutMetricsConversions.getMaxSize(i11), LayoutMetricsConversions.getMinSize(i12), LayoutMetricsConversions.getMaxSize(i12), i13, i14, z10, zDoLeftAndRightSwapInRTL);
    }
    ...
    public void receiveEvent(int i10, int i11, String str, boolean z10, WritableMap writableMap, int i12, boolean z11) {
        if (ReactBuildConfig.DEBUG && i10 == -1) {
            AbstractC2325a.d(TAG, "Emitted event without surfaceId: [%d] %s", Integer.valueOf(i11), str);
        }
        if (this.mDestroyed) {
            AbstractC2325a.m(TAG, "Attempted to receiveEvent after destruction");
            return;
        }
        ...
        if (eventEmitter == null) {
            ...
            AbstractC2325a.s(TAG, "Unable to invoke event: " + str + " for reactTag: " + i11);
            return;
        }
        if (z11) {
            UiThreadUtil.assertOnUiThread();
