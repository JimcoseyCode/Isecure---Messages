...
public class SurfaceMountingManager {
    ...
    private final j mTagToSynchronousMountProps = new j();
    ...
    public SurfaceMountingManager(int i10, JSResponderHandler jSResponderHandler, ViewManagerRegistry viewManagerRegistry, RootViewManager rootViewManager, MountingManager.MountItemExecutor mountItemExecutor, ThemedReactContext themedReactContext) {
        this.mSurfaceId = i10;
    ...
    private void addRootView(final View view) {
        ...
        GuardedRunnable guardedRunnable = new GuardedRunnable((ReactContext) AbstractC3007a.c(this.mThemedReactContext)) { // from class: com.facebook.react.fabric.mounting.SurfaceMountingManager.1
            ...
            public void runGuarded() {
                ...
                if (view.getId() == SurfaceMountingManager.this.mSurfaceId) {
                    ...
                    AbstractC2325a.o(str, "Trying to add RootTag to RootView that already has a tag: existing tag: [%d] new tag: [%d]", Integer.valueOf(view.getId()), Integer.valueOf(SurfaceMountingManager.this.mSurfaceId));
    ...
    public /* synthetic */ void lambda$stopSurface$0() {
        ...
        AbstractC2325a.m(TAG, "Surface [" + this.mSurfaceId + "] was stopped on SurfaceMountingManager.");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static void logViewHierarchy(ViewGroup viewGroup, boolean z10) {
        int id = viewGroup.getId();
        AbstractC2325a.m(TAG, "  <ViewGroup tag=" + id + " class=" + viewGroup.getClass().toString() + ">");
        for (int i10 = 0; i10 < viewGroup.getChildCount(); i10++) {
            AbstractC2325a.m(TAG, "     <View idx=" + i10 + " tag=" + viewGroup.getChildAt(i10).getId() + " class=" + viewGroup.getChildAt(i10).getClass().toString() + ">");
        }
        String str = TAG;
        AbstractC2325a.m(str, "  </ViewGroup tag=" + id + ">");
        if (z10) {
            AbstractC2325a.m(str, "Displaying Ancestors:");
            for (ViewParent parent = viewGroup.getParent(); parent != null; parent = parent.getParent()) {
                ViewGroup viewGroup2 = parent instanceof ViewGroup ? (ViewGroup) parent : null;
                int id2 = viewGroup2 == null ? -1 : viewGroup2.getId();
                AbstractC2325a.m(TAG, "<ViewParent tag=" + id2 + " class=" + parent.getClass().toString() + ">");
            }
        }
    }
    ...
    public void addViewAt(final int i10, final int i11, final int i12) {
        ...
        if (z10) {
            AbstractC2325a.m(TAG, "addViewAt: [" + i11 + "] -> [" + i10 + "] idx: " + i12 + " BEFORE");
        ...
        if (parent != null) {
            ...
            ReactSoftExceptionLogger.logSoftException(TAG, new IllegalStateException("addViewAt: cannot insert view [" + i11 + "] into parent [" + i10 + "]: View already has a parent: [" + id + "]  Parent: " + parent.getClass().getSimpleName() + " View: " + view2.getClass().getSimpleName()));
            if (z11) {
        ...
        try {
            ...
            if (z10) {
                UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.fabric.mounting.SurfaceMountingManager.2
                    ...
                    public void run() {
                        AbstractC2325a.m(SurfaceMountingManager.TAG, "addViewAt: [" + i11 + "] -> [" + i10 + "] idx: " + i12 + " AFTER");
    ...
    public void createView(String str, int i10, ReadableMap readableMap, StateWrapper stateWrapper, EventEmitterWrapper eventEmitterWrapper, boolean z10) {
        if (isStopped()) {
            return;
        }
    ...
    public void createViewUnsafe(String str, int i10, ReadableMap readableMap, StateWrapper stateWrapper, EventEmitterWrapper eventEmitterWrapper, boolean z10) {
        B3.a.c(0L, "SurfaceMountingManager::createViewUnsafe(" + str + ")");
        try {
    ...
    public void deleteView(int i10) {
        ...
        if (ReactNativeFeatureFlags.overrideBySynchronousMountPropsAtMountingAndroid() && this.mTagToSynchronousMountProps.e(i10)) {
    ...
    public void experimental_prefetchResources(int i10, String str, MapBuffer mapBuffer) {
        ...
        this.mViewManagerRegistry.get(str).experimental_prefetchResources(i10, (ThemedReactContext) AbstractC3007a.c(this.mThemedReactContext), mapBuffer);
    }
    ...
    public void preallocateView(String str, int i10, ReadableMap readableMap, StateWrapper stateWrapper, boolean z10) {
        UiThreadUtil.assertOnUiThread();
    ...
    public void printSurfaceState() {
        AbstractC2325a.o(TAG, "Views created for surface {%d}:", Integer.valueOf(getSurfaceId()));
        for (ViewState viewState : this.mTagToViewState.values()) {
            ...
            AbstractC2325a.o(TAG, "<%s id=%d parentTag=%s isRoot=%b />", name, Integer.valueOf(viewState.mReactTag), numValueOf, Boolean.valueOf(viewState.mIsRoot));
        }
    }
    ...
    public void removeViewAt(final int i10, final int i11, int i12) {
        ...
        if (SHOW_CHANGED_VIEW_HIERARCHIES) {
            AbstractC2325a.m(TAG, "removeViewAt: [" + i10 + "] -> [" + i11 + "] idx: " + i12 + " BEFORE");
            logViewHierarchy(viewGroup, false);
        }
        ...
        if (id != i10) {
            ...
            if (i14 == -1) {
                AbstractC2325a.m(TAG, "removeViewAt: [" + i10 + "] -> [" + i11 + "] @" + i12 + ": view already removed from parent! Children in parent: " + childCount);
                return;
            }
            logViewHierarchy(viewGroup, true);
            ReactSoftExceptionLogger.logSoftException(TAG, new IllegalStateException("Tried to remove view [" + i10 + "] of parent [" + i11 + "] at index " + i12 + ", but got view tag " + id + " - actual index of view: " + i14));
            i13 = i14;
        } else {
            i13 = i12;
        }
        try {
            ...
            if (SHOW_CHANGED_VIEW_HIERARCHIES) {
                UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.fabric.mounting.SurfaceMountingManager.3
                    @Override // java.lang.Runnable
                    public void run() {
                        AbstractC2325a.m(SurfaceMountingManager.TAG, "removeViewAt: [" + i10 + "] -> [" + i11 + "] idx: " + i13 + " AFTER");
                        SurfaceMountingManager.logViewHierarchy(viewGroup, false);
                    }
                });
            }
    ...
    public void stopSurface() {
        AbstractC2325a.m(TAG, "Stopping surface [" + this.mSurfaceId + "]");
        if (isStopped()) {
            return;
        }
        ...
        Runnable runnable = new Runnable() { // from class: com.facebook.react.fabric.mounting.b
            ...
            public final void run() {
                this.f20394g.lambda$stopSurface$0();
            }
        };
        if (UiThreadUtil.isOnUiThread()) {
            runnable.run();
    ...
    public void storeSynchronousMountPropsOverride(int i10, ReadableMap readableMap) {
        if (ReactNativeFeatureFlags.overrideBySynchronousMountPropsAtMountingAndroid()) {
            ...
            Map map = (Map) AbstractC3007a.c((Map) this.mTagToSynchronousMountProps.f(i10));
    ...
    */
    public void updateLayout(int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
        ...
        if (nullableViewState != null) {
            ...
            iViewGroupManager = nativeModule != null ? (IViewGroupManager) nativeModule : null;
    ...
    private void updateProps(int i10, ReadableMap readableMap, Boolean bool) {
        ...
        ViewState viewState = getViewState(i10);
        if (ReactNativeFeatureFlags.overrideBySynchronousMountPropsAtMountingAndroid() && !bool.booleanValue() && this.mTagToSynchronousMountProps.e(i10)) {
            WritableNativeMap writableNativeMap = new WritableNativeMap();
            writableNativeMap.merge(readableMap);
            overridePropsReadableMap((Map) AbstractC3007a.c((Map) this.mTagToSynchronousMountProps.f(i10)), writableNativeMap);
        ...
        View view = viewState.mView;
        if (view != null) {
            ((ViewManager) AbstractC3007a.c(viewState.mViewManager)).updateProperties(view, viewState.mCurrentProps);
            return;
        }
        throw new IllegalStateException("Unable to find view for tag [" + i10 + "]");
    }
