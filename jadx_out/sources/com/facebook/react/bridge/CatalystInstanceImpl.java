...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    public static class Builder {
        ...
        public CatalystInstanceImpl build() {
            return new CatalystInstanceImpl((ReactQueueConfigurationSpec) AbstractC3007a.c(this.mReactQueueConfigurationSpec), (JavaScriptExecutor) AbstractC3007a.c(this.mJSExecutor), (NativeModuleRegistry) AbstractC3007a.c(this.mRegistry), (JSBundleLoader) AbstractC3007a.c(this.mJSBundleLoader), (JSExceptionHandler) AbstractC3007a.c(this.mJSExceptionHandler), this.mInspectorTarget);
        }
    ...
    public static class PendingJSCall {
        ...
        public String toString() {
            ...
            sb.append(nativeArray == null ? PointerEventHelper.POINTER_TYPE_UNKNOWN : nativeArray.toString());
            sb.append(")");
            return sb.toString();
        }
    }
    ...
    public void decrementPendingJSCalls() {
        ...
        B3.a.m(0L, this.mJsPendingCallsTitleForTrace, iDecrementAndGet);
        ...
        this.mNativeModulesQueueThread.runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.g
            @Override // java.lang.Runnable
            public final void run() {
                this.f20286g.lambda$decrementPendingJSCalls$5();
            }
        });
    }
    ...
    private TurboModuleRegistry getTurboModuleRegistry() {
        if (ReactNativeNewArchitectureFeatureFlags.useTurboModules()) {
            return (TurboModuleRegistry) AbstractC3007a.d(this.mTurboModuleRegistry, "TurboModules are enabled, but mTurboModuleRegistry hasn't been set.");
        }
        return null;
    }
    ...
    public void incrementPendingJSCalls() {
        ...
        B3.a.m(0L, this.mJsPendingCallsTitleForTrace, andIncrement + 1);
        if (!z10 || this.mBridgeIdleListeners.isEmpty()) {
            return;
        }
        this.mNativeModulesQueueThread.runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.e
            @Override // java.lang.Runnable
            public final void run() {
                this.f20284g.lambda$incrementPendingJSCalls$4();
            }
        });
    }
    ...
    public /* synthetic */ void lambda$destroy$0() {
        ...
        AbstractC2325a.I(ReactConstants.TAG, "CatalystInstanceImpl.destroy() end");
    ...
    public void onNativeException(Exception exc) {
        ...
        this.mReactQueueConfiguration.getUIQueueThread().runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.c
            @Override // java.lang.Runnable
            public final void run() {
                this.f20282g.lambda$onNativeException$6();
            }
        });
    }
    ...
    public void lambda$onNativeException$6() {
        AbstractC2325a.b(ReactConstants.TAG, "CatalystInstanceImpl.destroy() start");
        ...
        if (reactInstanceManagerInspectorTarget != null) {
            AbstractC3007a.b(reactInstanceManagerInspectorTarget.isValid(), "ReactInstanceManager inspector target destroyed before instance was unregistered");
        }
        ...
        this.mNativeModulesQueueThread.runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.a
            @Override // java.lang.Runnable
            public final void run() {
                this.f20280g.lambda$destroy$2();
            }
        });
        B3.a.p(this.mTraceListener);
    }
    ...
    public void initialize() {
        AbstractC2325a.b(ReactConstants.TAG, "CatalystInstanceImpl.initialize()");
        AbstractC3007a.b(!this.mInitialized, "This catalyst instance has already been initialized");
        AbstractC3007a.b(this.mAcceptCalls, "RunJSBundle hasn't completed.");
        this.mInitialized = true;
        this.mNativeModulesQueueThread.runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.f
            @Override // java.lang.Runnable
            public final void run() {
                this.f20285g.lambda$initialize$3();
            }
        });
    }
    ...
    public void invokeCallback(int i10, NativeArrayInterface nativeArrayInterface) {
        if (this.mDestroyed) {
            AbstractC2325a.I(ReactConstants.TAG, "Invoking JS callback after bridge has been destroyed.");
        } else {
    ...
    public void runJSBundle() {
        AbstractC2325a.b(ReactConstants.TAG, "CatalystInstanceImpl.runJSBundle()");
        AbstractC3007a.b(!this.mJSBundleHasLoaded, "JS bundle was already loaded!");
    ...
    private CatalystInstanceImpl(ReactQueueConfigurationSpec reactQueueConfigurationSpec, JavaScriptExecutor javaScriptExecutor, NativeModuleRegistry nativeModuleRegistry, JSBundleLoader jSBundleLoader, JSExceptionHandler jSExceptionHandler, ReactInstanceManagerInspectorTarget reactInstanceManagerInspectorTarget) {
        ...
        AbstractC2325a.b(ReactConstants.TAG, "Initializing React Xplat Bridge.");
        B3.a.c(0L, "createCatalystInstanceImpl");
        ...
        this.mInspectorTarget = reactInstanceManagerInspectorTarget;
        B3.a.i(0L);
        AbstractC2325a.b(ReactConstants.TAG, "Initializing React Xplat Bridge before initializeBridge");
        B3.a.c(0L, "initializeCxxBridge");
        ...
        AbstractC2325a.b(ReactConstants.TAG, "Initializing React Xplat Bridge after initializeBridge");
        B3.a.i(0L);
    ...
    public void callFunction(PendingJSCall pendingJSCall) {
        if (this.mDestroyed) {
            AbstractC2325a.I(ReactConstants.TAG, "Calling JS function after bridge has been destroyed: " + pendingJSCall.toString());
            return;
        }
