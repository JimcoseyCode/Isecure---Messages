...
public class BridgeReactContext extends ReactApplicationContext {
    ...
    public CatalystInstance getCatalystInstance() {
        return (CatalystInstance) AbstractC3007a.c(this.mCatalystInstance);
    }
    ...
    public <T extends NativeModule> T getNativeModule(Class<T> cls) {
        ...
        AbstractC3007a.c(this.mCatalystInstance);
    ...
    public void handleException(Exception exc) {
        ...
        AbstractC2325a.n(ReactConstants.TAG, "Unable to handle Exception - catalystInstanceVariableExists: " + z10 + " - isCatalystInstanceAlive: " + z11 + " - hasExceptionHandler: " + z12, exc);
    ...
    public void registerSegment(int i10, String str, Callback callback) {
        ((CatalystInstance) AbstractC3007a.c(this.mCatalystInstance)).registerSegment(i10, str);
        ((Callback) AbstractC3007a.c(callback)).invoke(new Object[0]);
    }
