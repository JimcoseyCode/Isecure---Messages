...
public abstract class ReactContext extends ContextWrapper {
    ...
    public void assertOnJSQueueThread() {
        ((MessageQueueThread) AbstractC3007a.c(this.mJSMessageQueueThread)).assertIsOnThread();
    }
    ...
    public void assertOnNativeModulesQueueThread() {
        ...
        ((MessageQueueThread) AbstractC3007a.c(this.mNativeModulesMessageQueueThread)).assertIsOnThread();
    }

    public void assertOnUiQueueThread() {
        ((MessageQueueThread) AbstractC3007a.c(this.mUiMessageQueueThread)).assertIsOnThread();
    }
    ...
    public synchronized void initializeMessageQueueThreads(ReactQueueConfiguration reactQueueConfiguration) {
        AbstractC2325a.b(TAG, "initializeMessageQueueThreads() is called.");
    ...
    public boolean isOnJSQueueThread() {
        return ((MessageQueueThread) AbstractC3007a.c(this.mJSMessageQueueThread)).isOnThread();
    }

    public boolean isOnNativeModulesQueueThread() {
        return ((MessageQueueThread) AbstractC3007a.c(this.mNativeModulesMessageQueueThread)).isOnThread();
    }

    public boolean isOnUiQueueThread() {
        return ((MessageQueueThread) AbstractC3007a.c(this.mUiMessageQueueThread)).isOnThread();
    }
    ...
    public boolean runOnJSQueueThread(Runnable runnable) {
        return ((MessageQueueThread) AbstractC3007a.c(this.mJSMessageQueueThread)).runOnQueue(runnable);
    }

    public void runOnNativeModulesQueueThread(Runnable runnable) {
        ((MessageQueueThread) AbstractC3007a.c(this.mNativeModulesMessageQueueThread)).runOnQueue(runnable);
    }

    public void runOnUiQueueThread(Runnable runnable) {
        ((MessageQueueThread) AbstractC3007a.c(this.mUiMessageQueueThread)).runOnQueue(runnable);
    }
    ...
    public void assertOnNativeModulesQueueThread(String str) {
        if (this.mIsInitialized) {
            ((MessageQueueThread) AbstractC3007a.c(this.mNativeModulesMessageQueueThread)).assertIsOnThread(str);
            return;
        }
