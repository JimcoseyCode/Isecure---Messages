...
public class Collator {
    ...
    private void initializeCollator(List<String> list, Map<String, Object> map) throws JSRangeErrorException {
        ...
        this.mResolvedUsage = (IPlatformCollator.Usage) OptionHelpers.searchEnum(IPlatformCollator.Usage.class, JSObjects.getJavaString(OptionHelpers.GetOption(map, "usage", optionType, Constants.COLLATOR_USAGE_POSSIBLE_VALUES, Constants.SORT)));
