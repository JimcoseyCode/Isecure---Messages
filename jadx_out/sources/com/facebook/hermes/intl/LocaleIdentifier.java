...
public class LocaleIdentifier {
    ...
    static boolean handleExtensions(CharSequence charSequence, LocaleIdTokenizer localeIdTokenizer, LocaleIdTokenizer.LocaleIdSubtag localeIdSubtag, boolean z10, ParsedLocaleIdentifier parsedLocaleIdentifier) throws LocaleIdTokenizer.LocaleIdSubtagIterationFailed, JSRangeErrorException {
    ...
    static void parseLanguageId(CharSequence charSequence, LocaleIdTokenizer localeIdTokenizer, LocaleIdTokenizer.LocaleIdSubtag localeIdSubtag, boolean z10, ParsedLocaleIdentifier parsedLocaleIdentifier) throws LocaleIdTokenizer.LocaleIdSubtagIterationFailed, JSRangeErrorException {
        ...
        try {
            ...
            if (localeIdTokenizer.hasMoreSubtags()) {
                ...
                if (handleExtensions(charSequence, localeIdTokenizer, localeIdSubtagNextSubtag, z10, parsedLocaleIdentifier)) {
                    return;
                }
                ...
                while (!handleExtensions(charSequence, localeIdTokenizer, localeIdSubtagNextSubtag, z10, parsedLocaleIdentifier)) {
    ...
    static void parseOtherExtensions(CharSequence charSequence, LocaleIdTokenizer localeIdTokenizer, ParsedLocaleIdentifier parsedLocaleIdentifier, char c10) throws LocaleIdTokenizer.LocaleIdSubtagIterationFailed, JSRangeErrorException {
        if (!localeIdTokenizer.hasMoreSubtags()) {
            throw new JSRangeErrorException("Extension sequence expected.");
        }
        LocaleIdTokenizer.LocaleIdSubtag localeIdSubtagNextSubtag = localeIdTokenizer.nextSubtag();
