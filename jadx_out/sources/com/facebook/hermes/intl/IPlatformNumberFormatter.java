...
public interface IPlatformNumberFormatter {
    ...
    String format(double d10) throws JSRangeErrorException;

    AttributedCharacterIterator formatToParts(double d10) throws JSRangeErrorException;
    ...
    IPlatformNumberFormatter setSignificantDigits(RoundingType roundingType, int i10, int i11) throws JSRangeErrorException;
