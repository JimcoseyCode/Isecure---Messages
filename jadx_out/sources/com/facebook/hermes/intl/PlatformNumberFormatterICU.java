...
public class PlatformNumberFormatterICU implements IPlatformNumberFormatter {
    ...
    public PlatformNumberFormatterICU setSignDisplay(IPlatformNumberFormatter.SignDisplay signDisplay) {
        ...
        if (numberFormat instanceof DecimalFormat) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                ...
                if (i11 == 1) {
                    decimalFormat.setPositivePrefix(PointerEventHelper.POINTER_TYPE_UNKNOWN);
                    decimalFormat.setPositiveSuffix(PointerEventHelper.POINTER_TYPE_UNKNOWN);
                    decimalFormat.setNegativePrefix(PointerEventHelper.POINTER_TYPE_UNKNOWN);
                    decimalFormat.setNegativeSuffix(PointerEventHelper.POINTER_TYPE_UNKNOWN);
                } else if (i11 == 2 || i11 == 3) {
    ...
    @Override // com.facebook.hermes.intl.IPlatformNumberFormatter
    public PlatformNumberFormatterICU setSignificantDigits(IPlatformNumberFormatter.RoundingType roundingType, int i10, int i11) throws JSRangeErrorException {
        android.icu.text.NumberFormat numberFormat = this.mNumberFormat;
