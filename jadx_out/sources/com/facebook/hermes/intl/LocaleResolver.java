...
public class LocaleResolver {
    public static HashMap<String, Object> resolveLocale(List<String> list, Object obj, List<String> list2) throws JSRangeErrorException {
        ...
        LocaleMatcher.LocaleMatchResult localeMatchResultLookupMatch = JSObjects.getJavaString(JSObjects.Get(obj, Constants.LOCALEMATCHER)).equals("lookup") ? LocaleMatcher.lookupMatch((String[]) list.toArray(new String[list.size()])) : LocaleMatcher.bestFitMatch((String[]) list.toArray(new String[list.size()]));
