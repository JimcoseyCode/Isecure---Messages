...
public abstract class RenderableView extends VirtualView implements ReactHitSlopView {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f24508a[O.kMidMarker.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f24508a[O.kEndMarker.ordinal()] = 3;
    ...
    private void setupPaint(Paint paint, float f10, ReadableArray readableArray) {
        ...
        if (i10 == 1) {
            C2262a definedBrush = getSvgView().getDefinedBrush(readableArray.getString(1));
    ...
    public Rect getHitSlopRect() {
        if (this.mPointerEvents == PointerEvents.BOX_NONE) {
            return new Rect(androidx.customview.widget.a.INVALID_ID, androidx.customview.widget.a.INVALID_ID, androidx.customview.widget.a.INVALID_ID, androidx.customview.widget.a.INVALID_ID);
        }
        return null;
    }
    ...
    void render(Canvas canvas, Paint paint, float f10) {
        ...
        C2284w c2284w = this.mFilter != null ? (C2284w) getSvgView().getDefinedFilter(this.mFilter) : null;
        if (g10 == null && c2284w == null) {
        ...
        if (c2284w != null) {
            ...
            Bitmap bitmapC = c2284w.c(bitmapCreateBitmap, currentBitmap, clientRect);
            int iSave = canvas.save();
            canvas.setMatrix(null);
            canvas.drawBitmap(bitmapC, 0.0f, 0.0f, paint2);
        ...
        if (g10 != null) {
            ...
            if (g10.o() == C2262a.b.USER_SPACE_ON_USE) {
                float fRelativeOnWidth = (float) relativeOnWidth(g10.f24433l);
                float fRelativeOnHeight = (float) relativeOnHeight(g10.f24434m);
                rectF = new RectF(fRelativeOnWidth, fRelativeOnHeight, ((float) relativeOnWidth(g10.f24435n)) + fRelativeOnWidth, ((float) relativeOnHeight(g10.f24436o)) + fRelativeOnHeight);
            } else {
                ...
                float fRelativeOnFraction = (float) relativeOnFraction(g10.f24433l, clientRect2.width());
                float fRelativeOnFraction2 = (float) relativeOnFraction(g10.f24434m, clientRect2.height());
                float fRelativeOnFraction3 = (float) relativeOnFraction(g10.f24435n, clientRect2.width());
                float fRelativeOnFraction4 = (float) relativeOnFraction(g10.f24436o, clientRect2.height());
    ...
    void renderMarkers(Canvas canvas, Paint paint, float f10) {
        ...
        if (arrayList != null) {
            ...
            for (N n10 : arrayListH) {
                int i10 = a.f24508a[n10.f24483a.ordinal()];
                F f14 = i10 != 1 ? i10 != 2 ? i10 != 3 ? null : f13 : f12 : f11;
                if (f14 != null) {
                    Canvas canvas2 = canvas;
                    Paint paint2 = paint;
                    float f15 = f10;
                    f14.n(canvas2, paint2, f15, n10, fRelativeOnOther);
                    this.mMarkerPath.addPath(f14.getPath(canvas2, paint2), f14.f24432x);
                    canvas = canvas2;
                    paint = paint2;
                    f10 = f15;
                }
