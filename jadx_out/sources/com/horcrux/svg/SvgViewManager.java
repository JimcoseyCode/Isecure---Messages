...
class SvgViewManager extends ReactViewManager implements RNSVGSvgViewAndroidManagerInterface<SvgView> {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f24546a[ReadableType.Number.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f24546a[ReadableType.Null.ordinal()] = 3;
    ...
    public void setHitSlop(SvgView svgView, Dynamic dynamic) {
        int i10 = a.f24546a[dynamic.getType().ordinal()];
        if (i10 == 1) {
            ...
            if (i10 != 3) {
                AbstractC2325a.I(ReactConstants.TAG, "Invalid type for 'hitSlop' value " + dynamic.getType());
            }
