...
public abstract class VirtualView extends ReactViewGroup {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f24560a[SVGLength.UnitType.EXS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f24560a[SVGLength.UnitType.CM.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f24560a[SVGLength.UnitType.MM.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f24560a[SVGLength.UnitType.IN.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f24560a[SVGLength.UnitType.PT.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f24560a[SVGLength.UnitType.PC.ordinal()] = 7;
    ...
    private double fromRelativeFast(SVGLength sVGLength) {
        ...
        switch (a.f24560a[sVGLength.f24514b.ordinal()]) {
            case 1:
        ...
        return sVGLength.f24513a * fontSizeFromContext * ((double) this.mScale);
    }
    ...
    public SvgView getSvgView() {
        ...
        if (parent instanceof SvgView) {
            ...
            AbstractC2325a.m(ReactConstants.TAG, "RNSVG: " + getClass().getName() + " should be descendant of a SvgView.");
        }
        return this.svgView;
    }
    ...
    double relativeOn(SVGLength sVGLength, float f10) {
        SVGLength.UnitType unitType = sVGLength.f24514b;
        return unitType == SVGLength.UnitType.NUMBER ? sVGLength.f24513a * ((double) this.mScale) : unitType == SVGLength.UnitType.PERCENTAGE ? (sVGLength.f24513a / 100.0d) * ((double) f10) : fromRelativeFast(sVGLength);
    }
    ...
    double relativeOnHeight(SVGLength sVGLength) {
        SvgView svgView = getSvgView();
        return (sVGLength.f24514b != SVGLength.UnitType.PERCENTAGE || svgView == null || svgView.getViewBox().height() == 0.0f) ? relativeOn(sVGLength, getCanvasHeight()) : relativeOn(sVGLength, svgView.getViewBox().height());
    }
    ...
    double relativeOnWidth(SVGLength sVGLength) {
        SvgView svgView = getSvgView();
        return (sVGLength.f24514b != SVGLength.UnitType.PERCENTAGE || svgView == null || svgView.getViewBox().width() == 0.0f) ? relativeOn(sVGLength, getCanvasWidth()) : relativeOn(sVGLength, svgView.getViewBox().width());
    }
    ...
    Path getClipPath(Canvas canvas, Paint paint) {
        if (this.mClipPath != null) {
            C2264c c2264c = (C2264c) getSvgView().getDefinedClipPath(this.mClipPath);
            if (c2264c != null) {
                Path path = this.mClipRule == 0 ? c2264c.getPath(canvas, paint) : c2264c.f(canvas, paint, Region.Op.UNION);
                path.transform(c2264c.mMatrix);
                int i10 = this.mClipRule;
                if (i10 == 0) {
                    path.setFillType(Path.FillType.EVEN_ODD);
                } else if (i10 != 1) {
                    AbstractC2325a.I(ReactConstants.TAG, "RNSVG: clipRule: " + this.mClipRule + " unrecognized");
                }
                this.mCachedClipPath = path;
            } else {
                AbstractC2325a.I(ReactConstants.TAG, "RNSVG: Undefined clipPath: " + this.mClipPath);
            }
        }
        return getClipPath();
    }
