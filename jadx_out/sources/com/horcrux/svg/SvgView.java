...
public class SvgView extends ReactViewGroup implements ReactCompoundView, ReactCompoundViewGroup {
    ...
    int mCurrentColor;
    private final Map<String, C2262a> mDefinedBrushes;
    ...
    void defineBrush(C2262a c2262a, String str) {
        this.mDefinedBrushes.put(str, c2262a);
    }
    ...
    C2262a getDefinedBrush(String str) {
