...
.method private i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    .line 32
    invoke-static {v0, v1}, Lx0/A;->n(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    .line 50
    invoke-static {v0, v4}, Lx0/A;->n(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method private j(Landroid/os/CancellationSignal;LE0/h$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/Font;
    .locals 1

    .line 1
    invoke-virtual {p2}, LE0/h$b;->i()Z
    ...
    .line 6
    .line 7
    invoke-virtual {p0, p2}, Lx0/A;->m(LE0/h$b;)Landroid/graphics/fonts/Font;
    ...
    .line 12
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lx0/A;->l(Landroid/os/CancellationSignal;LE0/h$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/Font;
...
.method private l(Landroid/os/CancellationSignal;LE0/h$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/Font;
    .locals 3
    ...
    .line 2
    :try_start_0
    invoke-virtual {p2}, LE0/h$b;->e()Landroid/net/Uri;
    ...
    .line 49
    invoke-virtual {p2}, LE0/h$b;->f()Ljava/lang/String;
...
.method public a(Landroid/content/Context;Lw0/e$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    .line 46
    invoke-virtual {v3}, Lw0/e$d;->d()Ljava/lang/String;
    ...
    .line 84
    .line 85
    invoke-direct {p0, p2, p4}, Lx0/A;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[LE0/h$b;I)Landroid/graphics/Typeface;
    ...
    .line 6
    :try_start_0
    invoke-virtual {p0, p2, p3, p1}, Lx0/A;->k(Landroid/os/CancellationSignal;[LE0/h$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 17
    .line 18
    invoke-direct {p0, p1, p4}, Lx0/A;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public c(Landroid/content/Context;Landroid/os/CancellationSignal;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    .line 12
    .line 13
    invoke-virtual {p0, p2, v0, p1}, Lx0/A;->k(Landroid/os/CancellationSignal;[LE0/h$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 36
    check-cast v4, [LE0/h$b;

    .line 37
    .line 38
    invoke-virtual {p0, p2, v4, p1}, Lx0/A;->k(Landroid/os/CancellationSignal;[LE0/h$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 50
    :cond_2
    invoke-direct {p0, v0, p4}, Lx0/A;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method protected h([LE0/h$b;I)LE0/h$b;
    .locals 0
...
.method protected k(Landroid/os/CancellationSignal;[LE0/h$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 5
    ...
    .line 8
    .line 9
    invoke-direct {p0, p1, v4, p3}, Lx0/A;->j(Landroid/os/CancellationSignal;LE0/h$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/Font;
...
.method protected m(LE0/h$b;)Landroid/graphics/fonts/Font;
    .locals 1
