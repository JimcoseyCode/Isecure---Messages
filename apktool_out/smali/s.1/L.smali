...
.method constructor <init>(Landroid/hardware/camera2/CameraDevice;Ljava/lang/Object;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Ls/K;-><init>(Landroid/hardware/camera2/CameraDevice;Ljava/lang/Object;)V
...
.method static e(Landroid/hardware/camera2/CameraDevice;Landroid/os/Handler;)Ls/L;
    .locals 2
    ...
    .line 7
    .line 8
    invoke-direct {v0, p0, v1}, Ls/L;-><init>(Landroid/hardware/camera2/CameraDevice;Ljava/lang/Object;)V
...
.method public a(Lt/p;)V
    ...
    .line 2
    .line 3
    invoke-static {v0, p1}, Ls/N;->c(Landroid/hardware/camera2/CameraDevice;Lt/p;)V
    ...
    .line 7
    .line 8
    invoke-virtual {p1}, Lt/p;->a()Ljava/util/concurrent/Executor;
    ...
    .line 12
    invoke-virtual {p1}, Lt/p;->e()Landroid/hardware/camera2/CameraCaptureSession$StateCallback;
    ...
    .line 16
    invoke-direct {v0, v1, v2}, Ls/i$c;-><init>(Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;)V

    .line 17
    .line 18
    .line 19
    invoke-virtual {p1}, Lt/p;->c()Ljava/util/List;
    ...
    .line 23
    iget-object v2, p0, Ls/N;->b:Ljava/lang/Object;

    .line 24
    .line 25
    check-cast v2, Ls/N$a;
    ...
    .line 32
    .line 33
    iget-object v2, v2, Ls/N$a;->a:Landroid/os/Handler;

    .line 34
    .line 35
    invoke-virtual {p1}, Lt/p;->b()Lt/i;
    ...
    .line 41
    :try_start_0
    invoke-virtual {v3}, Lt/i;->a()Ljava/lang/Object;
    ...
    .line 49
    .line 50
    iget-object v3, p0, Ls/N;->a:Landroid/hardware/camera2/CameraDevice;

    .line 51
    .line 52
    invoke-static {v1}, Lt/p;->h(Ljava/util/List;)Ljava/util/List;
    ...
    .line 68
    .line 69
    iget-object p1, p0, Ls/N;->a:Landroid/hardware/camera2/CameraDevice;

    .line 70
    .line 71
    invoke-static {v1}, Ls/N;->d(Ljava/util/List;)Ljava/util/List;
