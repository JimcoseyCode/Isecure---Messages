...
.field private static volatile c:Lx4/b;
...
.method static constructor <clinit>()V
    ...
    .line 5
    .line 6
    sput-object v0, Lx4/b;->b:Ljava/lang/Object;
...
.method public static b()Lx4/b;
    ...
    .line 4
    .line 5
    sget-object v0, Lx4/b;->b:Ljava/lang/Object;
...
.method private final f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
    ...
    .line 18
    :try_start_0
    invoke-static {p1}, LA4/d;->a(Landroid/content/Context;)LA4/c;
    ...
    .line 22
    invoke-virtual {v1, p6, v0}, LA4/c;->b(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Lx4/b;->g(Landroid/content/ServiceConnection;)Z
    ...
    .line 39
    .line 40
    iget-object p6, p0, Lx4/b;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    :try_start_1
    invoke-static {p1, p3, p4, p5, p7}, Lx4/b;->h(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 72
    :cond_3
    iget-object p1, p0, Lx4/b;->a:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private static final h(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 11
    .line 12
    invoke-static {p0, p1, p3, p4, p2}, Lx4/a;->a(Landroid/content/Context;Landroid/content/Intent;ILjava/util/concurrent/Executor;Landroid/content/ServiceConnection;)Z
...
.method public a(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    .line 16
    invoke-direct/range {v1 .. v8}, Lx4/b;->f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
...
.method public c(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    .line 1
    invoke-static {p2}, Lx4/b;->g(Landroid/content/ServiceConnection;)Z
    ...
    .line 22
    .line 23
    invoke-static {p1, v0}, Lx4/b;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 39
    :cond_0
    invoke-static {p1, p2}, Lx4/b;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final d(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 10
    invoke-direct/range {v0 .. v7}, Lx4/b;->f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
