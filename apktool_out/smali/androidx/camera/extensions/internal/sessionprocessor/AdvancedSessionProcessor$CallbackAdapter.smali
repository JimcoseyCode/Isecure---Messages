...
.method private getImplRequest(LF/i1$b;)Landroidx/camera/extensions/impl/advanced/RequestProcessorImpl$Request;
    .locals 1
...
# virtual methods
.method public onCaptureBufferLost(LF/i1$b;JI)V
    .locals 1
    ...
    .line 2
    .line 3
    invoke-direct {p0, p1}, Landroidx/camera/extensions/internal/sessionprocessor/AdvancedSessionProcessor$CallbackAdapter;->getImplRequest(LF/i1$b;)Landroidx/camera/extensions/impl/advanced/RequestProcessorImpl$Request;
...
.method public onCaptureCompleted(LF/i1$b;LF/B;)V
    .locals 2

    .line 1
    invoke-interface {p2}, LF/B;->i()Landroid/hardware/camera2/CaptureResult;
...
.method public onCaptureFailed(LF/i1$b;LF/t;)V
    .locals 2

    .line 1
    invoke-virtual {p2}, LF/t;->a()Ljava/lang/Object;
...
.method public onCaptureProgressed(LF/i1$b;LF/B;)V
    .locals 2
...
.method public onCaptureStarted(LF/i1$b;JJ)V
    .locals 6
