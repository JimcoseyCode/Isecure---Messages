...
# instance fields
.field private final mCaptureCallback:LF/m1$a;
...
.field private final mTagBundle:LF/u1;

.field private mWillReceiveOnCaptureCompleted:Z


# direct methods
.method constructor <init>(LF/m1$a;LF/u1;Landroidx/camera/extensions/internal/sessionprocessor/AdvancedSessionProcessor$ExtensionMetadataMonitor;Z)V
    .locals 2
    ...
    .line 4
    iput-object p1, p0, Landroidx/camera/extensions/internal/sessionprocessor/AdvancedSessionProcessor$SessionProcessorImplCaptureCallbackAdapter;->mCaptureCallback:LF/m1$a;

    .line 5
    iput-object p2, p0, Landroidx/camera/extensions/internal/sessionprocessor/AdvancedSessionProcessor$SessionProcessorImplCaptureCallbackAdapter;->mTagBundle:LF/u1;
...
.method constructor <init>(LF/m1$a;LF/u1;Z)V
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-direct {p0, p1, p2, v0, p3}, Landroidx/camera/extensions/internal/sessionprocessor/AdvancedSessionProcessor$SessionProcessorImplCaptureCallbackAdapter;-><init>(LF/m1$a;LF/u1;Landroidx/camera/extensions/internal/sessionprocessor/AdvancedSessionProcessor$ExtensionMetadataMonitor;Z)V
...
.method public onCaptureCompleted(JILjava/util/Map;)V
    ...
    .line 11
    .line 12
    iget-object v0, p0, Landroidx/camera/extensions/internal/sessionprocessor/AdvancedSessionProcessor$SessionProcessorImplCaptureCallbackAdapter;->mCaptureCallback:LF/m1$a;
    ...
    .line 15
    .line 16
    iget-object v2, p0, Landroidx/camera/extensions/internal/sessionprocessor/AdvancedSessionProcessor$SessionProcessorImplCaptureCallbackAdapter;->mTagBundle:LF/u1;

    .line 17
    .line 18
    invoke-direct {v1, p1, p2, v2, p4}, Landroidx/camera/extensions/internal/sessionprocessor/e;-><init>(JLF/u1;Ljava/util/Map;)V

    .line 19
    .line 20
    .line 21
    invoke-interface {v0, p1, p2, p3, v1}, LF/m1$a;->e(JILF/B;)V

    .line 22
    .line 23
    .line 24
    iget-object p1, p0, Landroidx/camera/extensions/internal/sessionprocessor/AdvancedSessionProcessor$SessionProcessorImplCaptureCallbackAdapter;->mCaptureCallback:LF/m1$a;

    .line 25
    .line 26
    invoke-interface {p1, p3}, LF/m1$a;->b(I)V
...
.method public onCaptureFailed(I)V
    ...
    .line 2
    .line 3
    invoke-interface {v0, p1}, LF/m1$a;->c(I)V
...
.method public onCaptureProcessProgressed(I)V
    ...
    .line 2
    .line 3
    invoke-interface {v0, p1}, LF/m1$a;->onCaptureProcessProgressed(I)V
...
.method public onCaptureProcessStarted(I)V
    ...
    .line 2
    .line 3
    invoke-interface {v0, p1}, LF/m1$a;->a(I)V
...
.method public onCaptureSequenceAborted(I)V
    ...
    .line 2
    .line 3
    invoke-interface {v0, p1}, LF/m1$a;->f(I)V
...
.method public onCaptureSequenceCompleted(I)V
    ...
    .line 10
    .line 11
    iget-object v4, p0, Landroidx/camera/extensions/internal/sessionprocessor/AdvancedSessionProcessor$SessionProcessorImplCaptureCallbackAdapter;->mTagBundle:LF/u1;
    ...
    .line 14
    .line 15
    invoke-direct {v3, v1, v2, v4, v5}, Landroidx/camera/extensions/internal/sessionprocessor/e;-><init>(JLF/u1;Ljava/util/Map;)V

    .line 16
    .line 17
    .line 18
    invoke-interface {v0, v1, v2, p1, v3}, LF/m1$a;->e(JILF/B;)V
    ...
    .line 22
    .line 23
    invoke-interface {v0, p1}, LF/m1$a;->b(I)V
...
.method public onCaptureStarted(IJ)V
    ...
    .line 4
    .line 5
    invoke-interface {v0, p1, p2, p3}, LF/m1$a;->d(IJ)V
