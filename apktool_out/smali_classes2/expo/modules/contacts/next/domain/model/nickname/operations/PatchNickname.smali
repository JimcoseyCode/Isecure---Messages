.class public final Lexpo/modules/contacts/next/domain/model/nickname/operations/PatchNickname;
.super Lexpo/modules/contacts/next/domain/model/nickname/NicknameModel;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lexpo/modules/contacts/next/domain/model/nickname/NicknameModel;",
...
.method private constructor <init>(Ljava/lang/String;Lexpo/modules/kotlin/types/ValueOrUndefined;Lexpo/modules/kotlin/types/ValueOrUndefined;)V
    ...
    check-cast v1, Lexpo/modules/contacts/next/domain/model/nickname/NicknameLabel;

    if-nez v1, :cond_0

    new-instance v1, Lexpo/modules/contacts/next/domain/model/nickname/NicknameLabel$Custom;

    const-string v2, "other"

    invoke-direct {v1, v2}, Lexpo/modules/contacts/next/domain/model/nickname/NicknameLabel$Custom;-><init>(Ljava/lang/String;)V

    :cond_0
    invoke-direct {p0, v0, v1}, Lexpo/modules/contacts/next/domain/model/nickname/NicknameModel;-><init>(Ljava/lang/String;Lexpo/modules/contacts/next/domain/model/nickname/NicknameLabel;)V

    .line 9
    iput-object p1, p0, Lexpo/modules/contacts/next/domain/model/nickname/operations/PatchNickname;->dataId:Ljava/lang/String;
    ...
    check-cast p2, Lexpo/modules/contacts/next/domain/model/nickname/NicknameLabel;

    const/4 v0, 0x0

    if-eqz p2, :cond_2

    invoke-virtual {p2}, Lexpo/modules/contacts/next/domain/model/nickname/NicknameLabel;->getType()I
    ...
    invoke-virtual {p2}, Lexpo/modules/contacts/next/domain/model/nickname/NicknameLabel;->getLabel()Ljava/lang/String;
    ...
    .line 16
    :cond_4
    iput-object p1, p0, Lexpo/modules/contacts/next/domain/model/nickname/operations/PatchNickname;->contentValues:Landroid/content/ContentValues;
...
.method public synthetic constructor <init>(Ljava/lang/String;Lexpo/modules/kotlin/types/ValueOrUndefined;Lexpo/modules/kotlin/types/ValueOrUndefined;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 7
    invoke-direct {p0, p1, p2, p3, p4}, Lexpo/modules/contacts/next/domain/model/nickname/operations/PatchNickname;-><init>(Ljava/lang/String;Lexpo/modules/kotlin/types/ValueOrUndefined;Lexpo/modules/kotlin/types/ValueOrUndefined;Lkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public synthetic constructor <init>(Ljava/lang/String;Lexpo/modules/kotlin/types/ValueOrUndefined;Lexpo/modules/kotlin/types/ValueOrUndefined;Lkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2, p3}, Lexpo/modules/contacts/next/domain/model/nickname/operations/PatchNickname;-><init>(Ljava/lang/String;Lexpo/modules/kotlin/types/ValueOrUndefined;Lexpo/modules/kotlin/types/ValueOrUndefined;)V
...
.method public getContentValues()Landroid/content/ContentValues;
    ...
    .line 1
    iget-object v0, p0, Lexpo/modules/contacts/next/domain/model/nickname/operations/PatchNickname;->contentValues:Landroid/content/ContentValues;
...
.method public getDataId-sXKVoX8()Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Lexpo/modules/contacts/next/domain/model/nickname/operations/PatchNickname;->dataId:Ljava/lang/String;
