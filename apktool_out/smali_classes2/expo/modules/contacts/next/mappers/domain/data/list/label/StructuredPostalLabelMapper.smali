.class public final Lexpo/modules/contacts/next/mappers/domain/data/list/label/StructuredPostalLabelMapper;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lexpo/modules/contacts/next/mappers/domain/data/list/label/StructuredPostalLabelMapper;",
        "",
        "<init>",
        "()V",
        "toDomain",
...
# static fields
.field public static final INSTANCE:Lexpo/modules/contacts/next/mappers/domain/data/list/label/StructuredPostalLabelMapper;
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lexpo/modules/contacts/next/mappers/domain/data/list/label/StructuredPostalLabelMapper;

    .line 2
    .line 3
    invoke-direct {v0}, Lexpo/modules/contacts/next/mappers/domain/data/list/label/StructuredPostalLabelMapper;-><init>()V

    .line 4
    .line 5
    .line 6
    sput-object v0, Lexpo/modules/contacts/next/mappers/domain/data/list/label/StructuredPostalLabelMapper;->INSTANCE:Lexpo/modules/contacts/next/mappers/domain/data/list/label/StructuredPostalLabelMapper;
...
# virtual methods
.method public final toDomain(Ljava/lang/String;)Lexpo/modules/contacts/next/domain/model/structuredpostal/StructuredPostalLabel;
    .locals 4
    ...
    :cond_7
    :goto_1
    new-instance p1, Lexpo/modules/contacts/next/domain/model/structuredpostal/StructuredPostalLabel$Custom;

    invoke-direct {p1, v0}, Lexpo/modules/contacts/next/domain/model/structuredpostal/StructuredPostalLabel$Custom;-><init>(Ljava/lang/String;)V
...
.method public final toRecord(Lexpo/modules/contacts/next/domain/model/structuredpostal/StructuredPostalLabel;)Ljava/lang/String;
    .locals 1
    ...
    .line 5
    .line 6
    instance-of v0, p1, Lexpo/modules/contacts/next/domain/model/structuredpostal/StructuredPostalLabel$Home;
    ...
    .line 13
    :cond_0
    instance-of v0, p1, Lexpo/modules/contacts/next/domain/model/structuredpostal/StructuredPostalLabel$Work;
    ...
    .line 20
    :cond_1
    instance-of v0, p1, Lexpo/modules/contacts/next/domain/model/structuredpostal/StructuredPostalLabel$Other;
    ...
    .line 27
    :cond_2
    instance-of v0, p1, Lexpo/modules/contacts/next/domain/model/structuredpostal/StructuredPostalLabel$Custom;
    ...
    .line 30
    .line 31
    invoke-virtual {p1}, Lexpo/modules/contacts/next/domain/model/structuredpostal/StructuredPostalLabel;->getLabel()Ljava/lang/String;
