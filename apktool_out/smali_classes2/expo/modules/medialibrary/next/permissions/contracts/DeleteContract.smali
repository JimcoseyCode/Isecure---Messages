.class public final Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContract;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContract;",
        "Lexpo/modules/kotlin/activityresult/AppContextActivityResultContract;",
        "Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContractInput;",
        "",
        "appContextProvider",
        ...
        "",
        "intent",
        "(Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContractInput;ILandroid/content/Intent;)Ljava/lang/Boolean;",
...
.method public constructor <init>(Lexpo/modules/kotlin/providers/AppContextProvider;)V
    ...
    .line 8
    .line 9
    iput-object p1, p0, Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContract;->appContextProvider:Lexpo/modules/kotlin/providers/AppContextProvider;
...
.method private final getContentResolver()Landroid/content/ContentResolver;
    ...
    .line 1
    iget-object v0, p0, Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContract;->appContextProvider:Lexpo/modules/kotlin/providers/AppContextProvider;
...
# virtual methods
.method public createIntent(Landroid/content/Context;Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContractInput;)Landroid/content/Intent;
    .locals 1
    ...
    .line 2
    invoke-direct {p0}, Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContract;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object p1

    invoke-virtual {p2}, Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContractInput;->getUris()Ljava/util/List;
...
.method public bridge synthetic createIntent(Landroid/content/Context;Ljava/io/Serializable;)Landroid/content/Intent;
    ...
    .line 1
    check-cast p2, Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContractInput;

    invoke-virtual {p0, p1, p2}, Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContract;->createIntent(Landroid/content/Context;Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContractInput;)Landroid/content/Intent;
...
.method public parseResult(Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContractInput;ILandroid/content/Intent;)Ljava/lang/Boolean;
    .locals 0
...
.method public bridge synthetic parseResult(Ljava/io/Serializable;ILandroid/content/Intent;)Ljava/lang/Object;
    ...
    .line 1
    check-cast p1, Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContractInput;

    invoke-virtual {p0, p1, p2, p3}, Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContract;->parseResult(Lexpo/modules/medialibrary/next/permissions/contracts/DeleteContractInput;ILandroid/content/Intent;)Ljava/lang/Boolean;
